window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-permission-presets\src\client\PermissionRow.module.css.mjs
		const css = ".Lqr82a_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.Lqr82a_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.Lqr82a_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Lqr82a_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.Lqr82a_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Lqr82a_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Lqr82a_selector:disabled{cursor:default}.Lqr82a_chevron{flex:none}";
		...
		var PermissionRow_module_css_default = {
			"chevron": "Lqr82a_chevron",
			"desc": "Lqr82a_desc",
			"row": "Lqr82a_row",
			"rowText": "Lqr82a_rowText",
			"selector": "Lqr82a_selector",
			"title": "Lqr82a_title"
		};
		//#endregion
