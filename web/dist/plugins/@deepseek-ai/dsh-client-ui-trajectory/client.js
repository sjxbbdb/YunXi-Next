window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-0a50875c14b34d63b17f6522f5dab19c\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".bm_b4G_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.bm_b4G_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:bm_b4G_trajectory-table/inline-size}.bm_b4G_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.bm_b4G_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.bm_b4G_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite bm_b4G_history-loading-spin}.bm_b4G_table tbody .bm_b4G_historyLoadRow td{height:30px;padding:0}.bm_b4G_table tbody .bm_b4G_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.bm_b4G_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.bm_b4G_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.bm_b4G_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.bm_b4G_historyLoadButton:disabled{cursor:default}.bm_b4G_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.bm_b4G_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes bm_b4G_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.bm_b4G_historyLoadingSpinner{animation:none}}.bm_b4G_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.bm_b4G_eventColumn{width:122px}.bm_b4G_contentColumn{width:auto}.bm_b4G_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.bm_b4G_eventHeader{text-align:right!important;padding-right:4px!important}.bm_b4G_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.bm_b4G_table tbody .bm_b4G_virtualSpacer{pointer-events:none}.bm_b4G_table tbody .bm_b4G_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.bm_b4G_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.bm_b4G_table tbody tr[data-timeline-focus=outside]{opacity:.24}.bm_b4G_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.bm_b4G_table tbody tr[data-request-only=true]:hover{background:0 0}.bm_b4G_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.bm_b4G_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.bm_b4G_table tbody tr[data-request-only=true] .bm_b4G_turnRail{top:-15px;bottom:0}.bm_b4G_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.bm_b4G_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.bm_b4G_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.bm_b4G_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.bm_b4G_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.bm_b4G_requestBoundaryControl:hover:before,.bm_b4G_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.bm_b4G_requestBoundaryControlActive:before,.bm_b4G_requestBoundaryControlActive:hover:before,.bm_b4G_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.bm_b4G_requestBoundaryControl[data-request-status=error]:before,.bm_b4G_requestBoundaryControl[data-request-status=error]:hover:before,.bm_b4G_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.bm_b4G_requestBoundaryControl:hover:after,.bm_b4G_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.bm_b4G_requestBoundaryControl:focus-visible{outline:none}.bm_b4G_table tbody tr:has(.bm_b4G_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.bm_b4G_event{position:relative}.bm_b4G_turnRail,.bm_b4G_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.bm_b4G_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.bm_b4G_table tbody tr[data-turn-end=true] .bm_b4G_turnRail{bottom:0}.bm_b4G_selectionRail{z-index:5;width:3px;top:0;bottom:0}.bm_b4G_table tbody tr[data-error=true] .bm_b4G_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.bm_b4G_table tbody tr[data-error=true] .bm_b4G_selectionRail{background:var(--dsw-alias-state-error-primary)}.bm_b4G_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.bm_b4G_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.bm_b4G_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.bm_b4G_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.bm_b4G_turnLabelFull,.bm_b4G_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.bm_b4G_turnLabelCompact{opacity:0;max-width:0}.bm_b4G_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.bm_b4G_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.bm_b4G_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.bm_b4G_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.bm_b4G_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.bm_b4G_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.bm_b4G_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.bm_b4G_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.bm_b4G_table .bm_b4G_kindSlot .bm_b4G_message{justify-content:center;width:100%}@container bm_b4G_trajectory-table (width<=620px){.bm_b4G_eventColumn{width:50px}.bm_b4G_event{padding-left:28px!important;padding-right:3px!important}.bm_b4G_requestBoundaryControl{--request-boundary-base-left:6px}.bm_b4G_kindSlot{width:19px}.bm_b4G_kindTag,.bm_b4G_table .bm_b4G_kindSlot .bm_b4G_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.bm_b4G_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.bm_b4G_kindTagLabel,.bm_b4G_turnLabelFull{opacity:0;max-width:0}.bm_b4G_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.bm_b4G_eventColumn,.bm_b4G_event,.bm_b4G_requestBoundaryControl,.bm_b4G_kindSlot,.bm_b4G_kindTag,.bm_b4G_kindTagIcon,.bm_b4G_kindTagLabel,.bm_b4G_turnLabelFull,.bm_b4G_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.bm_b4G_eventColumn,.bm_b4G_kindSlot{transition-property:width}.bm_b4G_event{transition-property:padding-right,padding-left}.bm_b4G_requestBoundaryControl{transition-property:left}.bm_b4G_kindTag{transition-property:padding-right,padding-left}.bm_b4G_kindTagIcon{transition-property:width,opacity,transform}.bm_b4G_kindTagLabel,.bm_b4G_turnLabelFull,.bm_b4G_turnLabelCompact{transition-property:max-width,opacity}}.bm_b4G_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.bm_b4G_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.bm_b4G_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.bm_b4G_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.bm_b4G_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.bm_b4G_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.bm_b4G_promptDiffSection{min-width:0}.bm_b4G_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.bm_b4G_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.bm_b4G_promptDiff span{min-width:max-content;padding:0 6px;display:block}.bm_b4G_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.bm_b4G_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.bm_b4G_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.bm_b4G_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.bm_b4G_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.bm_b4G_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.bm_b4G_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.bm_b4G_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.bm_b4G_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.bm_b4G_table tbody tr[data-collapsed-summary=turn] td,.bm_b4G_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.bm_b4G_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.bm_b4G_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.bm_b4G_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.bm_b4G_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.bm_b4G_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.bm_b4G_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.bm_b4G_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.bm_b4G_resultRequest,.bm_b4G_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.bm_b4G_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.bm_b4G_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.bm_b4G_table tbody tr[data-kind=tool] .bm_b4G_contentText,.bm_b4G_table tbody tr[data-kind=subtool] .bm_b4G_contentText,.bm_b4G_table tbody tr[data-kind=tool] .bm_b4G_resultPreview,.bm_b4G_table tbody tr[data-kind=subtool] .bm_b4G_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.bm_b4G_table tbody tr[data-kind=subtool] .bm_b4G_content{padding-left:26px}.bm_b4G_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.bm_b4G_noOutputText{color:var(--dsw-alias-label-caption)}.bm_b4G_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.bm_b4G_error,.bm_b4G_overview dd.bm_b4G_error,.bm_b4G_details .bm_b4G_errorPayload{color:var(--dsw-alias-state-error-primary)}.bm_b4G_details .bm_b4G_errorPayload .bm_b4G_resultBlockText{color:inherit}.bm_b4G_details .bm_b4G_jsonPayload.bm_b4G_errorPayload,.bm_b4G_details .bm_b4G_jsonPreview.bm_b4G_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.bm_b4G_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.bm_b4G_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.bm_b4G_detailsResizeHandle:focus-visible{outline:none}.bm_b4G_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.bm_b4G_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.bm_b4G_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.bm_b4G_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.bm_b4G_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.bm_b4G_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.bm_b4G_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.bm_b4G_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.bm_b4G_detailTabs::-webkit-scrollbar{display:none}.bm_b4G_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.bm_b4G_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.bm_b4G_detailTabActive{color:var(--dsw-alias-state-business-primary)}.bm_b4G_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.bm_b4G_close:focus-visible,.bm_b4G_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.bm_b4G_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.bm_b4G_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.bm_b4G_detailBodySummary>.bm_b4G_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.bm_b4G_detailBodySummary>.bm_b4G_compactedSummary{flex:1;min-height:0;overflow:auto}.bm_b4G_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.bm_b4G_summaryScrollRegion:hover,.bm_b4G_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.bm_b4G_compactedSummary .bm_b4G_markdownPayload{padding-right:18px}.bm_b4G_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.bm_b4G_overviewParentLinks{gap:14px;display:flex}.bm_b4G_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.bm_b4G_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.bm_b4G_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.bm_b4G_overviewHierarchyNavLink:hover .bm_b4G_overviewHierarchyJumpIconTight,.bm_b4G_overviewHierarchyNavLink:focus-visible .bm_b4G_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.bm_b4G_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.bm_b4G_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.bm_b4G_overview>.bm_b4G_requestTokenDetail dt{padding-left:12px}.bm_b4G_usagePanel{padding:4px 0 10px}.bm_b4G_usageGroup+.bm_b4G_usageGroup{margin-top:8px}.bm_b4G_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.bm_b4G_usageGroup .bm_b4G_overview{padding:0}.bm_b4G_overview dt{color:var(--dsw-alias-label-tertiary)}.bm_b4G_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.bm_b4G_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.bm_b4G_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.bm_b4G_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.bm_b4G_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.bm_b4G_overviewSection+.bm_b4G_overviewSection{padding-top:8px}.bm_b4G_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.bm_b4G_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.bm_b4G_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.bm_b4G_overviewTitle:hover .bm_b4G_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.bm_b4G_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.bm_b4G_overviewTitle:focus-visible .bm_b4G_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.bm_b4G_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.bm_b4G_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.bm_b4G_overviewPreview .bm_b4G_jsonPreview>:first-child,.bm_b4G_overviewPreview .bm_b4G_schemaTree>:first-child{padding-bottom:0}.bm_b4G_overviewPreview .bm_b4G_schemaTree{margin-bottom:0}.bm_b4G_overviewPreview .bm_b4G_overview{padding:2px 0 0}.bm_b4G_overviewPreview .bm_b4G_overview>div{min-height:22px}.bm_b4G_markdownPreview,.bm_b4G_markdownPayload{color:var(--dsw-alias-label-primary)}.bm_b4G_markdownPreview>div,.bm_b4G_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.bm_b4G_markdownPreview>div h1,.bm_b4G_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.bm_b4G_markdownPreview>div h2,.bm_b4G_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.bm_b4G_markdownPreview>div :where(h3,h4,h5,h6),.bm_b4G_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.bm_b4G_markdownPreview>div :not(pre)>code,.bm_b4G_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.bm_b4G_markdownPreview>div table,.bm_b4G_markdownPayload>div table{font:var(--dsw-font-xs-13)}.bm_b4G_markdownPreview>div>:first-child{margin-top:0}.bm_b4G_markdownPreview>div>:last-child{margin-bottom:0}.bm_b4G_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.bm_b4G_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.bm_b4G_markdownPreview>div :where(p,ul,ol){margin:8px 0}.bm_b4G_markdownPreview>div li:not(:first-child){margin-top:3px}.bm_b4G_markdownPreview>div blockquote{margin-top:8px}.bm_b4G_markdownPreview>div hr{margin:14px 0}.bm_b4G_markdownPreview>div>.md-code-block{margin:10px 0}.bm_b4G_assistantContent .bm_b4G_markdownPayload,.bm_b4G_assistantContent .bm_b4G_payload{min-height:0}.bm_b4G_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.bm_b4G_thinkingQuoteOnlyPreview{margin-bottom:8px}.bm_b4G_detailBody>.bm_b4G_assistantContentRendered .bm_b4G_thinkingQuote{margin-top:14px}.bm_b4G_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.bm_b4G_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.bm_b4G_thinkingToggle[aria-expanded=true] .bm_b4G_thinkingChevron{transform:rotate(90deg)}.bm_b4G_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.bm_b4G_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.bm_b4G_thinkingQuote .bm_b4G_markdownPreview,.bm_b4G_thinkingQuote .bm_b4G_markdownPayload,.bm_b4G_thinkingQuote .bm_b4G_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.bm_b4G_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.bm_b4G_markdownPreview{padding:6px 14px 8px}.bm_b4G_markdownPayload{min-height:100%;padding:14px}.bm_b4G_jsonPayload{min-height:100%}.bm_b4G_jsonPreview{min-height:0}.bm_b4G_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.bm_b4G_schemaPreview{min-height:0}.bm_b4G_schemaIntro{padding:12px 14px 6px}.bm_b4G_schemaPreview .bm_b4G_schemaIntro{padding-top:6px}.bm_b4G_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.bm_b4G_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.bm_b4G_schemaParameters{min-width:0}.bm_b4G_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.bm_b4G_schemaTree{margin:0 6px 8px 0}.bm_b4G_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.bm_b4G_payloadPreview{min-height:0;padding:6px 14px 8px}.bm_b4G_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.bm_b4G_sourceBlock+.bm_b4G_sourceBlock{margin-top:14px}.bm_b4G_sourceBlockHeader,.bm_b4G_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.bm_b4G_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.bm_b4G_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.bm_b4G_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.bm_b4G_sourceBlockJumpTarget:hover .bm_b4G_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.bm_b4G_sourceBlockJumpTarget:focus-visible{outline:none}.bm_b4G_sourceBlockJumpTarget:focus-visible .bm_b4G_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.bm_b4G_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.bm_b4G_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.bm_b4G_panelImageLinkPreview{max-height:140px}.bm_b4G_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.bm_b4G_panelImageLinkPreview .bm_b4G_panelImage{max-height:140px}.bm_b4G_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.bm_b4G_messageImagesPreview{gap:6px;margin:6px 14px 8px}.bm_b4G_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.bm_b4G_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.bm_b4G_assistantToolCalls li{min-width:0}.bm_b4G_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.bm_b4G_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.bm_b4G_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.bm_b4G_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.bm_b4G_assistantToolCallButton:hover .bm_b4G_assistantToolCallIcon,.bm_b4G_assistantToolCallButton:focus-visible .bm_b4G_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.bm_b4G_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.bm_b4G_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.bm_b4G_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.bm_b4G_systemPrompt{box-sizing:border-box}.bm_b4G_toolCatalog{min-height:100%;padding:8px 0 16px}.bm_b4G_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.bm_b4G_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.bm_b4G_toolCatalogSummary::-webkit-details-marker{display:none}.bm_b4G_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.bm_b4G_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.bm_b4G_toolCatalogChevron,.bm_b4G_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.bm_b4G_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.bm_b4G_toolCatalogItem[open] .bm_b4G_toolCatalogChevron{transform:rotate(90deg)}.bm_b4G_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.bm_b4G_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.bm_b4G_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.bm_b4G_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.bm_b4G_toolCatalogTree{margin-left:-14px;margin-right:6px}.bm_b4G_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.bm_b4G_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.bm_b4G_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.bm_b4G_overviewPreview .bm_b4G_noPayload{padding:6px 14px 8px}.bm_b4G_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.bm_b4G_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "bm_b4G_arrow",
			"assistantContent": "bm_b4G_assistantContent",
			"assistantContentRendered": "bm_b4G_assistantContentRendered",
			"assistantOutput": "bm_b4G_assistantOutput",
			"assistantToolCallArgs": "bm_b4G_assistantToolCallArgs",
			"assistantToolCallButton": "bm_b4G_assistantToolCallButton",
			"assistantToolCallIcon": "bm_b4G_assistantToolCallIcon",
			"assistantToolCallName": "bm_b4G_assistantToolCallName",
			"assistantToolCallText": "bm_b4G_assistantToolCallText",
			"assistantToolCalls": "bm_b4G_assistantToolCalls",
			"assistantToolCallsPreview": "bm_b4G_assistantToolCallsPreview",
			"assistantVioletBright": "bm_b4G_assistantVioletBright",
			"close": "bm_b4G_close",
			"collapsedTurnContent": "bm_b4G_collapsedTurnContent",
			"collapsedTurnEllipsis": "bm_b4G_collapsedTurnEllipsis",
			"collapsedTurnText": "bm_b4G_collapsedTurnText",
			"compacted": "bm_b4G_compacted",
			"compactedSummary": "bm_b4G_compactedSummary",
			"content": "bm_b4G_content",
			"contentColumn": "bm_b4G_contentColumn",
			"contentText": "bm_b4G_contentText",
			"contextGreen": "bm_b4G_contextGreen",
			"detailBody": "bm_b4G_detailBody",
			"detailBodySummary": "bm_b4G_detailBodySummary",
			"detailTab": "bm_b4G_detailTab",
			"detailTabActive": "bm_b4G_detailTabActive",
			"detailTabs": "bm_b4G_detailTabs",
			"details": "bm_b4G_details",
			"detailsHeader": "bm_b4G_detailsHeader",
			"detailsLocation": "bm_b4G_detailsLocation",
			"detailsResizeHandle": "bm_b4G_detailsResizeHandle",
			"detailsTitle": "bm_b4G_detailsTitle",
			"error": "bm_b4G_error",
			"errorPayload": "bm_b4G_errorPayload",
			"event": "bm_b4G_event",
			"eventColumn": "bm_b4G_eventColumn",
			"eventHeader": "bm_b4G_eventHeader",
			"eventInner": "bm_b4G_eventInner",
			"history-loading-spin": "bm_b4G_history-loading-spin",
			"historyLoadButton": "bm_b4G_historyLoadButton",
			"historyLoadRow": "bm_b4G_historyLoadRow",
			"historyLoading": "bm_b4G_historyLoading",
			"historyLoadingBar": "bm_b4G_historyLoadingBar",
			"historyLoadingSpinner": "bm_b4G_historyLoadingSpinner",
			"inlineResult": "bm_b4G_inlineResult",
			"inlineResultText": "bm_b4G_inlineResultText",
			"jsonPayload": "bm_b4G_jsonPayload",
			"jsonPreview": "bm_b4G_jsonPreview",
			"kindSlot": "bm_b4G_kindSlot",
			"kindTag": "bm_b4G_kindTag",
			"kindTagIcon": "bm_b4G_kindTagIcon",
			"kindTagLabel": "bm_b4G_kindTagLabel",
			"markdownPayload": "bm_b4G_markdownPayload",
			"markdownPreview": "bm_b4G_markdownPreview",
			"message": "bm_b4G_message",
			"messageImages": "bm_b4G_messageImages",
			"messageImagesPreview": "bm_b4G_messageImagesPreview",
			"noOutputText": "bm_b4G_noOutputText",
			"noPayload": "bm_b4G_noPayload",
			"overview": "bm_b4G_overview",
			"overviewHeading": "bm_b4G_overviewHeading",
			"overviewHierarchyJumpIconTight": "bm_b4G_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "bm_b4G_overviewHierarchyNavLink",
			"overviewParentLinks": "bm_b4G_overviewParentLinks",
			"overviewPreview": "bm_b4G_overviewPreview",
			"overviewSection": "bm_b4G_overviewSection",
			"overviewSections": "bm_b4G_overviewSections",
			"overviewTitle": "bm_b4G_overviewTitle",
			"overviewTitleIcon": "bm_b4G_overviewTitleIcon",
			"panelImage": "bm_b4G_panelImage",
			"panelImageLink": "bm_b4G_panelImageLink",
			"panelImageLinkPreview": "bm_b4G_panelImageLinkPreview",
			"payload": "bm_b4G_payload",
			"payloadPreview": "bm_b4G_payloadPreview",
			"promptDiff": "bm_b4G_promptDiff",
			"promptDiffLineadded": "bm_b4G_promptDiffLineadded",
			"promptDiffLinecontext": "bm_b4G_promptDiffLinecontext",
			"promptDiffLinemeta": "bm_b4G_promptDiffLinemeta",
			"promptDiffLineremoved": "bm_b4G_promptDiffLineremoved",
			"promptDiffSection": "bm_b4G_promptDiffSection",
			"promptDiffSections": "bm_b4G_promptDiffSections",
			"promptDiffTitle": "bm_b4G_promptDiffTitle",
			"requestBoundaryControl": "bm_b4G_requestBoundaryControl",
			"requestBoundaryControlActive": "bm_b4G_requestBoundaryControlActive",
			"requestDetailsDot": "bm_b4G_requestDetailsDot",
			"requestDetailsName": "bm_b4G_requestDetailsName",
			"requestTokenDetail": "bm_b4G_requestTokenDetail",
			"resultBlockText": "bm_b4G_resultBlockText",
			"resultBlocks": "bm_b4G_resultBlocks",
			"resultBlocksPreview": "bm_b4G_resultBlocksPreview",
			"resultPreview": "bm_b4G_resultPreview",
			"resultRequest": "bm_b4G_resultRequest",
			"schema": "bm_b4G_schema",
			"schemaDescription": "bm_b4G_schemaDescription",
			"schemaIntro": "bm_b4G_schemaIntro",
			"schemaName": "bm_b4G_schemaName",
			"schemaParameters": "bm_b4G_schemaParameters",
			"schemaParametersTitle": "bm_b4G_schemaParametersTitle",
			"schemaPreview": "bm_b4G_schemaPreview",
			"schemaTree": "bm_b4G_schemaTree",
			"selectionRail": "bm_b4G_selectionRail",
			"sourceBlock": "bm_b4G_sourceBlock",
			"sourceBlockContent": "bm_b4G_sourceBlockContent",
			"sourceBlockHeader": "bm_b4G_sourceBlockHeader",
			"sourceBlockJumpIcon": "bm_b4G_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "bm_b4G_sourceBlockJumpTarget",
			"sourceBlockLabel": "bm_b4G_sourceBlockLabel",
			"sourceBlocks": "bm_b4G_sourceBlocks",
			"split": "bm_b4G_split",
			"subtoolAmber": "bm_b4G_subtoolAmber",
			"summaryScrollRegion": "bm_b4G_summaryScrollRegion",
			"systemNeutral": "bm_b4G_systemNeutral",
			"systemPrompt": "bm_b4G_systemPrompt",
			"table": "bm_b4G_table",
			"tablePane": "bm_b4G_tablePane",
			"thinkingChevron": "bm_b4G_thinkingChevron",
			"thinkingQuote": "bm_b4G_thinkingQuote",
			"thinkingQuoteOnlyPreview": "bm_b4G_thinkingQuoteOnlyPreview",
			"thinkingToggle": "bm_b4G_thinkingToggle",
			"timestampToggle": "bm_b4G_timestampToggle",
			"toolAmber": "bm_b4G_toolAmber",
			"toolCallNameTypeface": "bm_b4G_toolCallNameTypeface",
			"toolCallOnly": "bm_b4G_toolCallOnly",
			"toolCallPayload": "bm_b4G_toolCallPayload",
			"toolCatalog": "bm_b4G_toolCatalog",
			"toolCatalogChevron": "bm_b4G_toolCatalogChevron",
			"toolCatalogDefinition": "bm_b4G_toolCatalogDefinition",
			"toolCatalogDescription": "bm_b4G_toolCatalogDescription",
			"toolCatalogFullDescription": "bm_b4G_toolCatalogFullDescription",
			"toolCatalogIcon": "bm_b4G_toolCatalogIcon",
			"toolCatalogItem": "bm_b4G_toolCatalogItem",
			"toolCatalogName": "bm_b4G_toolCatalogName",
			"toolCatalogSummary": "bm_b4G_toolCatalogSummary",
			"toolCatalogTree": "bm_b4G_toolCatalogTree",
			"trajectory-table": "bm_b4G_trajectory-table",
			"turnLabel": "bm_b4G_turnLabel",
			"turnLabelActive": "bm_b4G_turnLabelActive",
			"turnLabelCompact": "bm_b4G_turnLabelCompact",
			"turnLabelFull": "bm_b4G_turnLabelFull",
			"turnRail": "bm_b4G_turnRail",
			"usageGroup": "bm_b4G_usageGroup",
			"usageHeading": "bm_b4G_usageHeading",
			"usagePanel": "bm_b4G_usagePanel",
			"user": "bm_b4G_user",
			"virtualSpacer": "bm_b4G_virtualSpacer",
			"visuallyHidden": "bm_b4G_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-0a50875c14b34d63b17f6522f5dab19c\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".PdUatq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.PdUatq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.PdUatq_actions{flex:none;align-items:center;gap:2px;display:flex}.PdUatq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.PdUatq_toggle:hover,.PdUatq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.PdUatq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.PdUatq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.PdUatq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.PdUatq_control[hidden]{display:none}.PdUatq_control:hover:not(:disabled),.PdUatq_control[aria-checked=true],.PdUatq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.PdUatq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.PdUatq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.PdUatq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.PdUatq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.PdUatq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.PdUatq_controlTrack[data-on=true] .PdUatq_controlThumb{transform:translate(10px)}.PdUatq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.PdUatq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.PdUatq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.PdUatq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.PdUatq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.PdUatq_search:hover{border-color:var(--dsw-alias-label-caption)}.PdUatq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.PdUatq_searchIcon{flex:none}.PdUatq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.PdUatq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.PdUatq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "PdUatq_action",
			"actionIcon": "PdUatq_actionIcon",
			"actions": "PdUatq_actions",
			"control": "PdUatq_control",
			"controlThumb": "PdUatq_controlThumb",
			"controlTrack": "PdUatq_controlTrack",
			"inner": "PdUatq_inner",
			"root": "PdUatq_root",
			"search": "PdUatq_search",
			"searchIcon": "PdUatq_searchIcon",
			"searchInput": "PdUatq_searchInput",
			"toggle": "PdUatq_toggle",
			"toggleIcon": "PdUatq_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-0a50875c14b34d63b17f6522f5dab19c\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = ".nLENEq_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.nLENEq_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.nLENEq_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.nLENEq_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.nLENEq_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.nLENEq_labels span:first-child{top:7px}.nLENEq_labels span:nth-child(2){top:21px}.nLENEq_labels span:nth-child(3){top:35px}.nLENEq_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.nLENEq_track[data-panning=true]{cursor:grabbing}.nLENEq_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.nLENEq_earlierHistory:hover{opacity:1}.nLENEq_earlierHistory[aria-disabled=true]{cursor:default}.nLENEq_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.nLENEq_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.nLENEq_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.nLENEq_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.nLENEq_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.nLENEq_lanes[data-animate-viewport=true],.nLENEq_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.nLENEq_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.nLENEq_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.nLENEq_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.nLENEq_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.nLENEq_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.nLENEq_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.nLENEq_span[data-timeline-span=tool],.nLENEq_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.nLENEq_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.nLENEq_span[data-equal-duration=true]{width:8px;min-width:8px}.nLENEq_span[data-selected=false]{opacity:.2}.nLENEq_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.nLENEq_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.nLENEq_span[data-search-match=false]{opacity:.14}.nLENEq_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.nLENEq_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.nLENEq_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.nLENEq_selectionEdges:before,.nLENEq_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.nLENEq_selectionEdges:before{left:0}.nLENEq_selectionEdges:after{right:0}.nLENEq_selectionEdges[data-dragging=true]:before,.nLENEq_selectionEdges[data-dragging=true]:after{width:2px}.nLENEq_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "nLENEq_earlierHistory",
			"empty": "nLENEq_empty",
			"hoverLine": "nLENEq_hoverLine",
			"labels": "nLENEq_labels",
			"lanes": "nLENEq_lanes",
			"plot": "nLENEq_plot",
			"root": "nLENEq_root",
			"selection": "nLENEq_selection",
			"selectionEdges": "nLENEq_selectionEdges",
			"span": "nLENEq_span",
			"track": "nLENEq_track",
			"turnBoundaries": "nLENEq_turnBoundaries",
			"turnBoundary": "nLENEq_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-0a50875c14b34d63b17f6522f5dab19c\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".C_ax3a_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.C_ax3a_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
