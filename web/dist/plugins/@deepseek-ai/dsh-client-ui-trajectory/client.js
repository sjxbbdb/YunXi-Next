window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".T4Kzna_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.T4Kzna_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:T4Kzna_trajectory-table/inline-size}.T4Kzna_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.T4Kzna_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.T4Kzna_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite T4Kzna_history-loading-spin}.T4Kzna_table tbody .T4Kzna_historyLoadRow td{height:30px;padding:0}.T4Kzna_table tbody .T4Kzna_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.T4Kzna_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.T4Kzna_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.T4Kzna_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.T4Kzna_historyLoadButton:disabled{cursor:default}.T4Kzna_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.T4Kzna_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes T4Kzna_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.T4Kzna_historyLoadingSpinner{animation:none}}.T4Kzna_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.T4Kzna_eventColumn{width:122px}.T4Kzna_contentColumn{width:auto}.T4Kzna_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.T4Kzna_eventHeader{text-align:right!important;padding-right:4px!important}.T4Kzna_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.T4Kzna_table tbody .T4Kzna_virtualSpacer{pointer-events:none}.T4Kzna_table tbody .T4Kzna_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.T4Kzna_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.T4Kzna_table tbody tr[data-timeline-focus=outside]{opacity:.24}.T4Kzna_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.T4Kzna_table tbody tr[data-request-only=true]:hover{background:0 0}.T4Kzna_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.T4Kzna_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.T4Kzna_table tbody tr[data-request-only=true] .T4Kzna_turnRail{top:-15px;bottom:0}.T4Kzna_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.T4Kzna_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.T4Kzna_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.T4Kzna_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.T4Kzna_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.T4Kzna_requestBoundaryControl:hover:before,.T4Kzna_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.T4Kzna_requestBoundaryControlActive:before,.T4Kzna_requestBoundaryControlActive:hover:before,.T4Kzna_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.T4Kzna_requestBoundaryControl[data-request-status=error]:before,.T4Kzna_requestBoundaryControl[data-request-status=error]:hover:before,.T4Kzna_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.T4Kzna_requestBoundaryControl:hover:after,.T4Kzna_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.T4Kzna_requestBoundaryControl:focus-visible{outline:none}.T4Kzna_table tbody tr:has(.T4Kzna_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.T4Kzna_event{position:relative}.T4Kzna_turnRail,.T4Kzna_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.T4Kzna_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.T4Kzna_table tbody tr[data-turn-end=true] .T4Kzna_turnRail{bottom:0}.T4Kzna_selectionRail{z-index:5;width:3px;top:0;bottom:0}.T4Kzna_table tbody tr[data-error=true] .T4Kzna_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.T4Kzna_table tbody tr[data-error=true] .T4Kzna_selectionRail{background:var(--dsw-alias-state-error-primary)}.T4Kzna_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.T4Kzna_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.T4Kzna_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.T4Kzna_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.T4Kzna_turnLabelFull,.T4Kzna_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.T4Kzna_turnLabelCompact{opacity:0;max-width:0}.T4Kzna_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.T4Kzna_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.T4Kzna_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.T4Kzna_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.T4Kzna_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.T4Kzna_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.T4Kzna_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.T4Kzna_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.T4Kzna_table .T4Kzna_kindSlot .T4Kzna_message{justify-content:center;width:100%}@container T4Kzna_trajectory-table (width<=620px){.T4Kzna_eventColumn{width:50px}.T4Kzna_event{padding-left:28px!important;padding-right:3px!important}.T4Kzna_requestBoundaryControl{--request-boundary-base-left:6px}.T4Kzna_kindSlot{width:19px}.T4Kzna_kindTag,.T4Kzna_table .T4Kzna_kindSlot .T4Kzna_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.T4Kzna_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.T4Kzna_kindTagLabel,.T4Kzna_turnLabelFull{opacity:0;max-width:0}.T4Kzna_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.T4Kzna_eventColumn,.T4Kzna_event,.T4Kzna_requestBoundaryControl,.T4Kzna_kindSlot,.T4Kzna_kindTag,.T4Kzna_kindTagIcon,.T4Kzna_kindTagLabel,.T4Kzna_turnLabelFull,.T4Kzna_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.T4Kzna_eventColumn,.T4Kzna_kindSlot{transition-property:width}.T4Kzna_event{transition-property:padding-right,padding-left}.T4Kzna_requestBoundaryControl{transition-property:left}.T4Kzna_kindTag{transition-property:padding-right,padding-left}.T4Kzna_kindTagIcon{transition-property:width,opacity,transform}.T4Kzna_kindTagLabel,.T4Kzna_turnLabelFull,.T4Kzna_turnLabelCompact{transition-property:max-width,opacity}}.T4Kzna_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.T4Kzna_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.T4Kzna_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.T4Kzna_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.T4Kzna_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.T4Kzna_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.T4Kzna_promptDiffSection{min-width:0}.T4Kzna_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.T4Kzna_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.T4Kzna_promptDiff span{min-width:max-content;padding:0 6px;display:block}.T4Kzna_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.T4Kzna_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.T4Kzna_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.T4Kzna_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.T4Kzna_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.T4Kzna_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.T4Kzna_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.T4Kzna_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.T4Kzna_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.T4Kzna_table tbody tr[data-collapsed-summary=turn] td,.T4Kzna_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.T4Kzna_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.T4Kzna_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.T4Kzna_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.T4Kzna_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.T4Kzna_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.T4Kzna_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.T4Kzna_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.T4Kzna_resultRequest,.T4Kzna_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.T4Kzna_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.T4Kzna_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.T4Kzna_table tbody tr[data-kind=tool] .T4Kzna_contentText,.T4Kzna_table tbody tr[data-kind=subtool] .T4Kzna_contentText,.T4Kzna_table tbody tr[data-kind=tool] .T4Kzna_resultPreview,.T4Kzna_table tbody tr[data-kind=subtool] .T4Kzna_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.T4Kzna_table tbody tr[data-kind=subtool] .T4Kzna_content{padding-left:26px}.T4Kzna_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.T4Kzna_noOutputText{color:var(--dsw-alias-label-caption)}.T4Kzna_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.T4Kzna_error,.T4Kzna_overview dd.T4Kzna_error,.T4Kzna_details .T4Kzna_errorPayload{color:var(--dsw-alias-state-error-primary)}.T4Kzna_details .T4Kzna_errorPayload .T4Kzna_resultBlockText{color:inherit}.T4Kzna_details .T4Kzna_jsonPayload.T4Kzna_errorPayload,.T4Kzna_details .T4Kzna_jsonPreview.T4Kzna_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.T4Kzna_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.T4Kzna_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.T4Kzna_detailsResizeHandle:focus-visible{outline:none}.T4Kzna_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.T4Kzna_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.T4Kzna_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.T4Kzna_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.T4Kzna_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.T4Kzna_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.T4Kzna_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.T4Kzna_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.T4Kzna_detailTabs::-webkit-scrollbar{display:none}.T4Kzna_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.T4Kzna_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.T4Kzna_detailTabActive{color:var(--dsw-alias-state-business-primary)}.T4Kzna_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.T4Kzna_close:focus-visible,.T4Kzna_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.T4Kzna_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.T4Kzna_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.T4Kzna_detailBodySummary>.T4Kzna_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.T4Kzna_detailBodySummary>.T4Kzna_compactedSummary{flex:1;min-height:0;overflow:auto}.T4Kzna_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.T4Kzna_summaryScrollRegion:hover,.T4Kzna_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.T4Kzna_compactedSummary .T4Kzna_markdownPayload{padding-right:18px}.T4Kzna_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.T4Kzna_overviewParentLinks{gap:14px;display:flex}.T4Kzna_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.T4Kzna_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.T4Kzna_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.T4Kzna_overviewHierarchyNavLink:hover .T4Kzna_overviewHierarchyJumpIconTight,.T4Kzna_overviewHierarchyNavLink:focus-visible .T4Kzna_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.T4Kzna_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.T4Kzna_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.T4Kzna_overview>.T4Kzna_requestTokenDetail dt{padding-left:12px}.T4Kzna_usagePanel{padding:4px 0 10px}.T4Kzna_usageGroup+.T4Kzna_usageGroup{margin-top:8px}.T4Kzna_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.T4Kzna_usageGroup .T4Kzna_overview{padding:0}.T4Kzna_overview dt{color:var(--dsw-alias-label-tertiary)}.T4Kzna_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.T4Kzna_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.T4Kzna_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.T4Kzna_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.T4Kzna_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.T4Kzna_overviewSection+.T4Kzna_overviewSection{padding-top:8px}.T4Kzna_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.T4Kzna_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.T4Kzna_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.T4Kzna_overviewTitle:hover .T4Kzna_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.T4Kzna_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.T4Kzna_overviewTitle:focus-visible .T4Kzna_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.T4Kzna_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.T4Kzna_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.T4Kzna_overviewPreview .T4Kzna_jsonPreview>:first-child,.T4Kzna_overviewPreview .T4Kzna_schemaTree>:first-child{padding-bottom:0}.T4Kzna_overviewPreview .T4Kzna_schemaTree{margin-bottom:0}.T4Kzna_overviewPreview .T4Kzna_overview{padding:2px 0 0}.T4Kzna_overviewPreview .T4Kzna_overview>div{min-height:22px}.T4Kzna_markdownPreview,.T4Kzna_markdownPayload{color:var(--dsw-alias-label-primary)}.T4Kzna_markdownPreview>div,.T4Kzna_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.T4Kzna_markdownPreview>div h1,.T4Kzna_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.T4Kzna_markdownPreview>div h2,.T4Kzna_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.T4Kzna_markdownPreview>div :where(h3,h4,h5,h6),.T4Kzna_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.T4Kzna_markdownPreview>div :not(pre)>code,.T4Kzna_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.T4Kzna_markdownPreview>div table,.T4Kzna_markdownPayload>div table{font:var(--dsw-font-xs-13)}.T4Kzna_markdownPreview>div>:first-child{margin-top:0}.T4Kzna_markdownPreview>div>:last-child{margin-bottom:0}.T4Kzna_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.T4Kzna_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.T4Kzna_markdownPreview>div :where(p,ul,ol){margin:8px 0}.T4Kzna_markdownPreview>div li:not(:first-child){margin-top:3px}.T4Kzna_markdownPreview>div blockquote{margin-top:8px}.T4Kzna_markdownPreview>div hr{margin:14px 0}.T4Kzna_markdownPreview>div>.md-code-block{margin:10px 0}.T4Kzna_assistantContent .T4Kzna_markdownPayload,.T4Kzna_assistantContent .T4Kzna_payload{min-height:0}.T4Kzna_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.T4Kzna_thinkingQuoteOnlyPreview{margin-bottom:8px}.T4Kzna_detailBody>.T4Kzna_assistantContentRendered .T4Kzna_thinkingQuote{margin-top:14px}.T4Kzna_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.T4Kzna_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.T4Kzna_thinkingToggle[aria-expanded=true] .T4Kzna_thinkingChevron{transform:rotate(90deg)}.T4Kzna_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.T4Kzna_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.T4Kzna_thinkingQuote .T4Kzna_markdownPreview,.T4Kzna_thinkingQuote .T4Kzna_markdownPayload,.T4Kzna_thinkingQuote .T4Kzna_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.T4Kzna_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.T4Kzna_markdownPreview{padding:6px 14px 8px}.T4Kzna_markdownPayload{min-height:100%;padding:14px}.T4Kzna_jsonPayload{min-height:100%}.T4Kzna_jsonPreview{min-height:0}.T4Kzna_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.T4Kzna_schemaPreview{min-height:0}.T4Kzna_schemaIntro{padding:12px 14px 6px}.T4Kzna_schemaPreview .T4Kzna_schemaIntro{padding-top:6px}.T4Kzna_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.T4Kzna_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.T4Kzna_schemaParameters{min-width:0}.T4Kzna_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.T4Kzna_schemaTree{margin:0 6px 8px 0}.T4Kzna_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.T4Kzna_payloadPreview{min-height:0;padding:6px 14px 8px}.T4Kzna_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.T4Kzna_sourceBlock+.T4Kzna_sourceBlock{margin-top:14px}.T4Kzna_sourceBlockHeader,.T4Kzna_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.T4Kzna_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.T4Kzna_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.T4Kzna_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.T4Kzna_sourceBlockJumpTarget:hover .T4Kzna_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.T4Kzna_sourceBlockJumpTarget:focus-visible{outline:none}.T4Kzna_sourceBlockJumpTarget:focus-visible .T4Kzna_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.T4Kzna_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.T4Kzna_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.T4Kzna_panelImageLinkPreview{max-height:140px}.T4Kzna_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.T4Kzna_panelImageLinkPreview .T4Kzna_panelImage{max-height:140px}.T4Kzna_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.T4Kzna_messageImagesPreview{gap:6px;margin:6px 14px 8px}.T4Kzna_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.T4Kzna_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.T4Kzna_assistantToolCalls li{min-width:0}.T4Kzna_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.T4Kzna_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.T4Kzna_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.T4Kzna_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.T4Kzna_assistantToolCallButton:hover .T4Kzna_assistantToolCallIcon,.T4Kzna_assistantToolCallButton:focus-visible .T4Kzna_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.T4Kzna_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.T4Kzna_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.T4Kzna_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.T4Kzna_systemPrompt{box-sizing:border-box}.T4Kzna_toolCatalog{min-height:100%;padding:8px 0 16px}.T4Kzna_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.T4Kzna_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.T4Kzna_toolCatalogSummary::-webkit-details-marker{display:none}.T4Kzna_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.T4Kzna_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.T4Kzna_toolCatalogChevron,.T4Kzna_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.T4Kzna_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.T4Kzna_toolCatalogItem[open] .T4Kzna_toolCatalogChevron{transform:rotate(90deg)}.T4Kzna_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.T4Kzna_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.T4Kzna_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.T4Kzna_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.T4Kzna_toolCatalogTree{margin-left:-14px;margin-right:6px}.T4Kzna_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.T4Kzna_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.T4Kzna_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.T4Kzna_overviewPreview .T4Kzna_noPayload{padding:6px 14px 8px}.T4Kzna_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.T4Kzna_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "T4Kzna_arrow",
			"assistantContent": "T4Kzna_assistantContent",
			"assistantContentRendered": "T4Kzna_assistantContentRendered",
			"assistantOutput": "T4Kzna_assistantOutput",
			"assistantToolCallArgs": "T4Kzna_assistantToolCallArgs",
			"assistantToolCallButton": "T4Kzna_assistantToolCallButton",
			"assistantToolCallIcon": "T4Kzna_assistantToolCallIcon",
			"assistantToolCallName": "T4Kzna_assistantToolCallName",
			"assistantToolCallText": "T4Kzna_assistantToolCallText",
			"assistantToolCalls": "T4Kzna_assistantToolCalls",
			"assistantToolCallsPreview": "T4Kzna_assistantToolCallsPreview",
			"assistantVioletBright": "T4Kzna_assistantVioletBright",
			"close": "T4Kzna_close",
			"collapsedTurnContent": "T4Kzna_collapsedTurnContent",
			"collapsedTurnEllipsis": "T4Kzna_collapsedTurnEllipsis",
			"collapsedTurnText": "T4Kzna_collapsedTurnText",
			"compacted": "T4Kzna_compacted",
			"compactedSummary": "T4Kzna_compactedSummary",
			"content": "T4Kzna_content",
			"contentColumn": "T4Kzna_contentColumn",
			"contentText": "T4Kzna_contentText",
			"contextGreen": "T4Kzna_contextGreen",
			"detailBody": "T4Kzna_detailBody",
			"detailBodySummary": "T4Kzna_detailBodySummary",
			"detailTab": "T4Kzna_detailTab",
			"detailTabActive": "T4Kzna_detailTabActive",
			"detailTabs": "T4Kzna_detailTabs",
			"details": "T4Kzna_details",
			"detailsHeader": "T4Kzna_detailsHeader",
			"detailsLocation": "T4Kzna_detailsLocation",
			"detailsResizeHandle": "T4Kzna_detailsResizeHandle",
			"detailsTitle": "T4Kzna_detailsTitle",
			"error": "T4Kzna_error",
			"errorPayload": "T4Kzna_errorPayload",
			"event": "T4Kzna_event",
			"eventColumn": "T4Kzna_eventColumn",
			"eventHeader": "T4Kzna_eventHeader",
			"eventInner": "T4Kzna_eventInner",
			"history-loading-spin": "T4Kzna_history-loading-spin",
			"historyLoadButton": "T4Kzna_historyLoadButton",
			"historyLoadRow": "T4Kzna_historyLoadRow",
			"historyLoading": "T4Kzna_historyLoading",
			"historyLoadingBar": "T4Kzna_historyLoadingBar",
			"historyLoadingSpinner": "T4Kzna_historyLoadingSpinner",
			"inlineResult": "T4Kzna_inlineResult",
			"inlineResultText": "T4Kzna_inlineResultText",
			"jsonPayload": "T4Kzna_jsonPayload",
			"jsonPreview": "T4Kzna_jsonPreview",
			"kindSlot": "T4Kzna_kindSlot",
			"kindTag": "T4Kzna_kindTag",
			"kindTagIcon": "T4Kzna_kindTagIcon",
			"kindTagLabel": "T4Kzna_kindTagLabel",
			"markdownPayload": "T4Kzna_markdownPayload",
			"markdownPreview": "T4Kzna_markdownPreview",
			"message": "T4Kzna_message",
			"messageImages": "T4Kzna_messageImages",
			"messageImagesPreview": "T4Kzna_messageImagesPreview",
			"noOutputText": "T4Kzna_noOutputText",
			"noPayload": "T4Kzna_noPayload",
			"overview": "T4Kzna_overview",
			"overviewHeading": "T4Kzna_overviewHeading",
			"overviewHierarchyJumpIconTight": "T4Kzna_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "T4Kzna_overviewHierarchyNavLink",
			"overviewParentLinks": "T4Kzna_overviewParentLinks",
			"overviewPreview": "T4Kzna_overviewPreview",
			"overviewSection": "T4Kzna_overviewSection",
			"overviewSections": "T4Kzna_overviewSections",
			"overviewTitle": "T4Kzna_overviewTitle",
			"overviewTitleIcon": "T4Kzna_overviewTitleIcon",
			"panelImage": "T4Kzna_panelImage",
			"panelImageLink": "T4Kzna_panelImageLink",
			"panelImageLinkPreview": "T4Kzna_panelImageLinkPreview",
			"payload": "T4Kzna_payload",
			"payloadPreview": "T4Kzna_payloadPreview",
			"promptDiff": "T4Kzna_promptDiff",
			"promptDiffLineadded": "T4Kzna_promptDiffLineadded",
			"promptDiffLinecontext": "T4Kzna_promptDiffLinecontext",
			"promptDiffLinemeta": "T4Kzna_promptDiffLinemeta",
			"promptDiffLineremoved": "T4Kzna_promptDiffLineremoved",
			"promptDiffSection": "T4Kzna_promptDiffSection",
			"promptDiffSections": "T4Kzna_promptDiffSections",
			"promptDiffTitle": "T4Kzna_promptDiffTitle",
			"requestBoundaryControl": "T4Kzna_requestBoundaryControl",
			"requestBoundaryControlActive": "T4Kzna_requestBoundaryControlActive",
			"requestDetailsDot": "T4Kzna_requestDetailsDot",
			"requestDetailsName": "T4Kzna_requestDetailsName",
			"requestTokenDetail": "T4Kzna_requestTokenDetail",
			"resultBlockText": "T4Kzna_resultBlockText",
			"resultBlocks": "T4Kzna_resultBlocks",
			"resultBlocksPreview": "T4Kzna_resultBlocksPreview",
			"resultPreview": "T4Kzna_resultPreview",
			"resultRequest": "T4Kzna_resultRequest",
			"schema": "T4Kzna_schema",
			"schemaDescription": "T4Kzna_schemaDescription",
			"schemaIntro": "T4Kzna_schemaIntro",
			"schemaName": "T4Kzna_schemaName",
			"schemaParameters": "T4Kzna_schemaParameters",
			"schemaParametersTitle": "T4Kzna_schemaParametersTitle",
			"schemaPreview": "T4Kzna_schemaPreview",
			"schemaTree": "T4Kzna_schemaTree",
			"selectionRail": "T4Kzna_selectionRail",
			"sourceBlock": "T4Kzna_sourceBlock",
			"sourceBlockContent": "T4Kzna_sourceBlockContent",
			"sourceBlockHeader": "T4Kzna_sourceBlockHeader",
			"sourceBlockJumpIcon": "T4Kzna_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "T4Kzna_sourceBlockJumpTarget",
			"sourceBlockLabel": "T4Kzna_sourceBlockLabel",
			"sourceBlocks": "T4Kzna_sourceBlocks",
			"split": "T4Kzna_split",
			"subtoolAmber": "T4Kzna_subtoolAmber",
			"summaryScrollRegion": "T4Kzna_summaryScrollRegion",
			"systemNeutral": "T4Kzna_systemNeutral",
			"systemPrompt": "T4Kzna_systemPrompt",
			"table": "T4Kzna_table",
			"tablePane": "T4Kzna_tablePane",
			"thinkingChevron": "T4Kzna_thinkingChevron",
			"thinkingQuote": "T4Kzna_thinkingQuote",
			"thinkingQuoteOnlyPreview": "T4Kzna_thinkingQuoteOnlyPreview",
			"thinkingToggle": "T4Kzna_thinkingToggle",
			"timestampToggle": "T4Kzna_timestampToggle",
			"toolAmber": "T4Kzna_toolAmber",
			"toolCallNameTypeface": "T4Kzna_toolCallNameTypeface",
			"toolCallOnly": "T4Kzna_toolCallOnly",
			"toolCallPayload": "T4Kzna_toolCallPayload",
			"toolCatalog": "T4Kzna_toolCatalog",
			"toolCatalogChevron": "T4Kzna_toolCatalogChevron",
			"toolCatalogDefinition": "T4Kzna_toolCatalogDefinition",
			"toolCatalogDescription": "T4Kzna_toolCatalogDescription",
			"toolCatalogFullDescription": "T4Kzna_toolCatalogFullDescription",
			"toolCatalogIcon": "T4Kzna_toolCatalogIcon",
			"toolCatalogItem": "T4Kzna_toolCatalogItem",
			"toolCatalogName": "T4Kzna_toolCatalogName",
			"toolCatalogSummary": "T4Kzna_toolCatalogSummary",
			"toolCatalogTree": "T4Kzna_toolCatalogTree",
			"trajectory-table": "T4Kzna_trajectory-table",
			"turnLabel": "T4Kzna_turnLabel",
			"turnLabelActive": "T4Kzna_turnLabelActive",
			"turnLabelCompact": "T4Kzna_turnLabelCompact",
			"turnLabelFull": "T4Kzna_turnLabelFull",
			"turnRail": "T4Kzna_turnRail",
			"usageGroup": "T4Kzna_usageGroup",
			"usageHeading": "T4Kzna_usageHeading",
			"usagePanel": "T4Kzna_usagePanel",
			"user": "T4Kzna_user",
			"virtualSpacer": "T4Kzna_virtualSpacer",
			"visuallyHidden": "T4Kzna_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = "._3YYvYG_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}._3YYvYG_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}._3YYvYG_actions{flex:none;align-items:center;gap:2px;display:flex}._3YYvYG_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}._3YYvYG_toggle:hover,._3YYvYG_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._3YYvYG_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._3YYvYG_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}._3YYvYG_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}._3YYvYG_control[hidden]{display:none}._3YYvYG_control:hover:not(:disabled),._3YYvYG_control[aria-checked=true],._3YYvYG_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}._3YYvYG_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._3YYvYG_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._3YYvYG_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}._3YYvYG_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}._3YYvYG_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}._3YYvYG_controlTrack[data-on=true] ._3YYvYG_controlThumb{transform:translate(10px)}._3YYvYG_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}._3YYvYG_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._3YYvYG_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._3YYvYG_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}._3YYvYG_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}._3YYvYG_search:hover{border-color:var(--dsw-alias-label-caption)}._3YYvYG_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}._3YYvYG_searchIcon{flex:none}._3YYvYG_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}._3YYvYG_searchInput::placeholder{color:var(--dsw-alias-label-caption)}._3YYvYG_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "_3YYvYG_action",
			"actionIcon": "_3YYvYG_actionIcon",
			"actions": "_3YYvYG_actions",
			"control": "_3YYvYG_control",
			"controlThumb": "_3YYvYG_controlThumb",
			"controlTrack": "_3YYvYG_controlTrack",
			"inner": "_3YYvYG_inner",
			"root": "_3YYvYG_root",
			"search": "_3YYvYG_search",
			"searchIcon": "_3YYvYG_searchIcon",
			"searchInput": "_3YYvYG_searchInput",
			"toggle": "_3YYvYG_toggle",
			"toggleIcon": "_3YYvYG_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = "._6uWiSW_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}._6uWiSW_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}._6uWiSW_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}._6uWiSW_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}._6uWiSW_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}._6uWiSW_labels span:first-child{top:7px}._6uWiSW_labels span:nth-child(2){top:21px}._6uWiSW_labels span:nth-child(3){top:35px}._6uWiSW_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}._6uWiSW_track[data-panning=true]{cursor:grabbing}._6uWiSW_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}._6uWiSW_earlierHistory:hover{opacity:1}._6uWiSW_earlierHistory[aria-disabled=true]{cursor:default}._6uWiSW_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}._6uWiSW_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._6uWiSW_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._6uWiSW_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}._6uWiSW_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){._6uWiSW_lanes[data-animate-viewport=true],._6uWiSW_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}._6uWiSW_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}._6uWiSW_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}._6uWiSW_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}._6uWiSW_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}._6uWiSW_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}._6uWiSW_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}._6uWiSW_span[data-timeline-span=tool],._6uWiSW_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}._6uWiSW_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}._6uWiSW_span[data-equal-duration=true]{width:8px;min-width:8px}._6uWiSW_span[data-selected=false]{opacity:.2}._6uWiSW_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}._6uWiSW_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}._6uWiSW_span[data-search-match=false]{opacity:.14}._6uWiSW_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}._6uWiSW_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}._6uWiSW_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}._6uWiSW_selectionEdges:before,._6uWiSW_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}._6uWiSW_selectionEdges:before{left:0}._6uWiSW_selectionEdges:after{right:0}._6uWiSW_selectionEdges[data-dragging=true]:before,._6uWiSW_selectionEdges[data-dragging=true]:after{width:2px}._6uWiSW_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "_6uWiSW_earlierHistory",
			"empty": "_6uWiSW_empty",
			"hoverLine": "_6uWiSW_hoverLine",
			"labels": "_6uWiSW_labels",
			"lanes": "_6uWiSW_lanes",
			"plot": "_6uWiSW_plot",
			"root": "_6uWiSW_root",
			"selection": "_6uWiSW_selection",
			"selectionEdges": "_6uWiSW_selectionEdges",
			"span": "_6uWiSW_span",
			"track": "_6uWiSW_track",
			"turnBoundaries": "_6uWiSW_turnBoundaries",
			"turnBoundary": "_6uWiSW_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".iShtfq_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.iShtfq_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
