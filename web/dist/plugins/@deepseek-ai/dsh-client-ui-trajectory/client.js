window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-ab5a0433e27742b99ef765dc97041378\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".k18r4W_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.k18r4W_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:k18r4W_trajectory-table/inline-size}.k18r4W_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.k18r4W_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.k18r4W_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite k18r4W_history-loading-spin}.k18r4W_table tbody .k18r4W_historyLoadRow td{height:30px;padding:0}.k18r4W_table tbody .k18r4W_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.k18r4W_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.k18r4W_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.k18r4W_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.k18r4W_historyLoadButton:disabled{cursor:default}.k18r4W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.k18r4W_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes k18r4W_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.k18r4W_historyLoadingSpinner{animation:none}}.k18r4W_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.k18r4W_eventColumn{width:122px}.k18r4W_contentColumn{width:auto}.k18r4W_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.k18r4W_eventHeader{text-align:right!important;padding-right:4px!important}.k18r4W_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.k18r4W_table tbody .k18r4W_virtualSpacer{pointer-events:none}.k18r4W_table tbody .k18r4W_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.k18r4W_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.k18r4W_table tbody tr[data-timeline-focus=outside]{opacity:.24}.k18r4W_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.k18r4W_table tbody tr[data-request-only=true]:hover{background:0 0}.k18r4W_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.k18r4W_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.k18r4W_table tbody tr[data-request-only=true] .k18r4W_turnRail{top:-15px;bottom:0}.k18r4W_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.k18r4W_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.k18r4W_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.k18r4W_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.k18r4W_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.k18r4W_requestBoundaryControl:hover:before,.k18r4W_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.k18r4W_requestBoundaryControlActive:before,.k18r4W_requestBoundaryControlActive:hover:before,.k18r4W_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.k18r4W_requestBoundaryControl[data-request-status=error]:before,.k18r4W_requestBoundaryControl[data-request-status=error]:hover:before,.k18r4W_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.k18r4W_requestBoundaryControl:hover:after,.k18r4W_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.k18r4W_requestBoundaryControl:focus-visible{outline:none}.k18r4W_table tbody tr:has(.k18r4W_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.k18r4W_event{position:relative}.k18r4W_turnRail,.k18r4W_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.k18r4W_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.k18r4W_table tbody tr[data-turn-end=true] .k18r4W_turnRail{bottom:0}.k18r4W_selectionRail{z-index:5;width:3px;top:0;bottom:0}.k18r4W_table tbody tr[data-error=true] .k18r4W_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.k18r4W_table tbody tr[data-error=true] .k18r4W_selectionRail{background:var(--dsw-alias-state-error-primary)}.k18r4W_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.k18r4W_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.k18r4W_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.k18r4W_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.k18r4W_turnLabelFull,.k18r4W_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.k18r4W_turnLabelCompact{opacity:0;max-width:0}.k18r4W_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.k18r4W_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.k18r4W_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.k18r4W_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.k18r4W_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.k18r4W_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.k18r4W_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.k18r4W_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.k18r4W_table .k18r4W_kindSlot .k18r4W_message{justify-content:center;width:100%}@container k18r4W_trajectory-table (width<=620px){.k18r4W_eventColumn{width:50px}.k18r4W_event{padding-left:28px!important;padding-right:3px!important}.k18r4W_requestBoundaryControl{--request-boundary-base-left:6px}.k18r4W_kindSlot{width:19px}.k18r4W_kindTag,.k18r4W_table .k18r4W_kindSlot .k18r4W_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.k18r4W_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.k18r4W_kindTagLabel,.k18r4W_turnLabelFull{opacity:0;max-width:0}.k18r4W_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.k18r4W_eventColumn,.k18r4W_event,.k18r4W_requestBoundaryControl,.k18r4W_kindSlot,.k18r4W_kindTag,.k18r4W_kindTagIcon,.k18r4W_kindTagLabel,.k18r4W_turnLabelFull,.k18r4W_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.k18r4W_eventColumn,.k18r4W_kindSlot{transition-property:width}.k18r4W_event{transition-property:padding-right,padding-left}.k18r4W_requestBoundaryControl{transition-property:left}.k18r4W_kindTag{transition-property:padding-right,padding-left}.k18r4W_kindTagIcon{transition-property:width,opacity,transform}.k18r4W_kindTagLabel,.k18r4W_turnLabelFull,.k18r4W_turnLabelCompact{transition-property:max-width,opacity}}.k18r4W_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.k18r4W_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.k18r4W_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.k18r4W_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.k18r4W_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.k18r4W_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.k18r4W_promptDiffSection{min-width:0}.k18r4W_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.k18r4W_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.k18r4W_promptDiff span{min-width:max-content;padding:0 6px;display:block}.k18r4W_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.k18r4W_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.k18r4W_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.k18r4W_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.k18r4W_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.k18r4W_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.k18r4W_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.k18r4W_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.k18r4W_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.k18r4W_table tbody tr[data-collapsed-summary=turn] td,.k18r4W_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.k18r4W_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.k18r4W_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.k18r4W_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.k18r4W_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.k18r4W_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.k18r4W_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.k18r4W_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.k18r4W_resultRequest,.k18r4W_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.k18r4W_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.k18r4W_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.k18r4W_table tbody tr[data-kind=tool] .k18r4W_contentText,.k18r4W_table tbody tr[data-kind=subtool] .k18r4W_contentText,.k18r4W_table tbody tr[data-kind=tool] .k18r4W_resultPreview,.k18r4W_table tbody tr[data-kind=subtool] .k18r4W_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.k18r4W_table tbody tr[data-kind=subtool] .k18r4W_content{padding-left:26px}.k18r4W_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.k18r4W_noOutputText{color:var(--dsw-alias-label-caption)}.k18r4W_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.k18r4W_error,.k18r4W_overview dd.k18r4W_error,.k18r4W_details .k18r4W_errorPayload{color:var(--dsw-alias-state-error-primary)}.k18r4W_details .k18r4W_errorPayload .k18r4W_resultBlockText{color:inherit}.k18r4W_details .k18r4W_jsonPayload.k18r4W_errorPayload,.k18r4W_details .k18r4W_jsonPreview.k18r4W_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.k18r4W_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.k18r4W_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.k18r4W_detailsResizeHandle:focus-visible{outline:none}.k18r4W_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.k18r4W_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.k18r4W_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.k18r4W_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.k18r4W_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.k18r4W_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.k18r4W_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.k18r4W_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.k18r4W_detailTabs::-webkit-scrollbar{display:none}.k18r4W_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.k18r4W_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.k18r4W_detailTabActive{color:var(--dsw-alias-state-business-primary)}.k18r4W_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.k18r4W_close:focus-visible,.k18r4W_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.k18r4W_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.k18r4W_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.k18r4W_detailBodySummary>.k18r4W_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.k18r4W_detailBodySummary>.k18r4W_compactedSummary{flex:1;min-height:0;overflow:auto}.k18r4W_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.k18r4W_summaryScrollRegion:hover,.k18r4W_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.k18r4W_compactedSummary .k18r4W_markdownPayload{padding-right:18px}.k18r4W_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.k18r4W_overviewParentLinks{gap:14px;display:flex}.k18r4W_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.k18r4W_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.k18r4W_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.k18r4W_overviewHierarchyNavLink:hover .k18r4W_overviewHierarchyJumpIconTight,.k18r4W_overviewHierarchyNavLink:focus-visible .k18r4W_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.k18r4W_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.k18r4W_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.k18r4W_overview>.k18r4W_requestTokenDetail dt{padding-left:12px}.k18r4W_usagePanel{padding:4px 0 10px}.k18r4W_usageGroup+.k18r4W_usageGroup{margin-top:8px}.k18r4W_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.k18r4W_usageGroup .k18r4W_overview{padding:0}.k18r4W_overview dt{color:var(--dsw-alias-label-tertiary)}.k18r4W_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.k18r4W_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.k18r4W_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.k18r4W_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.k18r4W_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.k18r4W_overviewSection+.k18r4W_overviewSection{padding-top:8px}.k18r4W_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.k18r4W_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.k18r4W_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.k18r4W_overviewTitle:hover .k18r4W_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.k18r4W_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.k18r4W_overviewTitle:focus-visible .k18r4W_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.k18r4W_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.k18r4W_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.k18r4W_overviewPreview .k18r4W_jsonPreview>:first-child,.k18r4W_overviewPreview .k18r4W_schemaTree>:first-child{padding-bottom:0}.k18r4W_overviewPreview .k18r4W_schemaTree{margin-bottom:0}.k18r4W_overviewPreview .k18r4W_overview{padding:2px 0 0}.k18r4W_overviewPreview .k18r4W_overview>div{min-height:22px}.k18r4W_markdownPreview,.k18r4W_markdownPayload{color:var(--dsw-alias-label-primary)}.k18r4W_markdownPreview>div,.k18r4W_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.k18r4W_markdownPreview>div h1,.k18r4W_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.k18r4W_markdownPreview>div h2,.k18r4W_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.k18r4W_markdownPreview>div :where(h3,h4,h5,h6),.k18r4W_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.k18r4W_markdownPreview>div :not(pre)>code,.k18r4W_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.k18r4W_markdownPreview>div table,.k18r4W_markdownPayload>div table{font:var(--dsw-font-xs-13)}.k18r4W_markdownPreview>div>:first-child{margin-top:0}.k18r4W_markdownPreview>div>:last-child{margin-bottom:0}.k18r4W_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.k18r4W_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.k18r4W_markdownPreview>div :where(p,ul,ol){margin:8px 0}.k18r4W_markdownPreview>div li:not(:first-child){margin-top:3px}.k18r4W_markdownPreview>div blockquote{margin-top:8px}.k18r4W_markdownPreview>div hr{margin:14px 0}.k18r4W_markdownPreview>div>.md-code-block{margin:10px 0}.k18r4W_assistantContent .k18r4W_markdownPayload,.k18r4W_assistantContent .k18r4W_payload{min-height:0}.k18r4W_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.k18r4W_thinkingQuoteOnlyPreview{margin-bottom:8px}.k18r4W_detailBody>.k18r4W_assistantContentRendered .k18r4W_thinkingQuote{margin-top:14px}.k18r4W_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.k18r4W_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.k18r4W_thinkingToggle[aria-expanded=true] .k18r4W_thinkingChevron{transform:rotate(90deg)}.k18r4W_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.k18r4W_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.k18r4W_thinkingQuote .k18r4W_markdownPreview,.k18r4W_thinkingQuote .k18r4W_markdownPayload,.k18r4W_thinkingQuote .k18r4W_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.k18r4W_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.k18r4W_markdownPreview{padding:6px 14px 8px}.k18r4W_markdownPayload{min-height:100%;padding:14px}.k18r4W_jsonPayload{min-height:100%}.k18r4W_jsonPreview{min-height:0}.k18r4W_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.k18r4W_schemaPreview{min-height:0}.k18r4W_schemaIntro{padding:12px 14px 6px}.k18r4W_schemaPreview .k18r4W_schemaIntro{padding-top:6px}.k18r4W_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.k18r4W_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.k18r4W_schemaParameters{min-width:0}.k18r4W_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.k18r4W_schemaTree{margin:0 6px 8px 0}.k18r4W_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.k18r4W_payloadPreview{min-height:0;padding:6px 14px 8px}.k18r4W_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.k18r4W_sourceBlock+.k18r4W_sourceBlock{margin-top:14px}.k18r4W_sourceBlockHeader,.k18r4W_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.k18r4W_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.k18r4W_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.k18r4W_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.k18r4W_sourceBlockJumpTarget:hover .k18r4W_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.k18r4W_sourceBlockJumpTarget:focus-visible{outline:none}.k18r4W_sourceBlockJumpTarget:focus-visible .k18r4W_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.k18r4W_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.k18r4W_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.k18r4W_panelImageLinkPreview{max-height:140px}.k18r4W_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.k18r4W_panelImageLinkPreview .k18r4W_panelImage{max-height:140px}.k18r4W_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.k18r4W_messageImagesPreview{gap:6px;margin:6px 14px 8px}.k18r4W_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.k18r4W_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.k18r4W_assistantToolCalls li{min-width:0}.k18r4W_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.k18r4W_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.k18r4W_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.k18r4W_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.k18r4W_assistantToolCallButton:hover .k18r4W_assistantToolCallIcon,.k18r4W_assistantToolCallButton:focus-visible .k18r4W_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.k18r4W_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.k18r4W_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.k18r4W_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.k18r4W_systemPrompt{box-sizing:border-box}.k18r4W_toolCatalog{min-height:100%;padding:8px 0 16px}.k18r4W_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.k18r4W_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.k18r4W_toolCatalogSummary::-webkit-details-marker{display:none}.k18r4W_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.k18r4W_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.k18r4W_toolCatalogChevron,.k18r4W_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.k18r4W_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.k18r4W_toolCatalogItem[open] .k18r4W_toolCatalogChevron{transform:rotate(90deg)}.k18r4W_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.k18r4W_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.k18r4W_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.k18r4W_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.k18r4W_toolCatalogTree{margin-left:-14px;margin-right:6px}.k18r4W_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.k18r4W_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.k18r4W_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.k18r4W_overviewPreview .k18r4W_noPayload{padding:6px 14px 8px}.k18r4W_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.k18r4W_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "k18r4W_arrow",
			"assistantContent": "k18r4W_assistantContent",
			"assistantContentRendered": "k18r4W_assistantContentRendered",
			"assistantOutput": "k18r4W_assistantOutput",
			"assistantToolCallArgs": "k18r4W_assistantToolCallArgs",
			"assistantToolCallButton": "k18r4W_assistantToolCallButton",
			"assistantToolCallIcon": "k18r4W_assistantToolCallIcon",
			"assistantToolCallName": "k18r4W_assistantToolCallName",
			"assistantToolCallText": "k18r4W_assistantToolCallText",
			"assistantToolCalls": "k18r4W_assistantToolCalls",
			"assistantToolCallsPreview": "k18r4W_assistantToolCallsPreview",
			"assistantVioletBright": "k18r4W_assistantVioletBright",
			"close": "k18r4W_close",
			"collapsedTurnContent": "k18r4W_collapsedTurnContent",
			"collapsedTurnEllipsis": "k18r4W_collapsedTurnEllipsis",
			"collapsedTurnText": "k18r4W_collapsedTurnText",
			"compacted": "k18r4W_compacted",
			"compactedSummary": "k18r4W_compactedSummary",
			"content": "k18r4W_content",
			"contentColumn": "k18r4W_contentColumn",
			"contentText": "k18r4W_contentText",
			"contextGreen": "k18r4W_contextGreen",
			"detailBody": "k18r4W_detailBody",
			"detailBodySummary": "k18r4W_detailBodySummary",
			"detailTab": "k18r4W_detailTab",
			"detailTabActive": "k18r4W_detailTabActive",
			"detailTabs": "k18r4W_detailTabs",
			"details": "k18r4W_details",
			"detailsHeader": "k18r4W_detailsHeader",
			"detailsLocation": "k18r4W_detailsLocation",
			"detailsResizeHandle": "k18r4W_detailsResizeHandle",
			"detailsTitle": "k18r4W_detailsTitle",
			"error": "k18r4W_error",
			"errorPayload": "k18r4W_errorPayload",
			"event": "k18r4W_event",
			"eventColumn": "k18r4W_eventColumn",
			"eventHeader": "k18r4W_eventHeader",
			"eventInner": "k18r4W_eventInner",
			"history-loading-spin": "k18r4W_history-loading-spin",
			"historyLoadButton": "k18r4W_historyLoadButton",
			"historyLoadRow": "k18r4W_historyLoadRow",
			"historyLoading": "k18r4W_historyLoading",
			"historyLoadingBar": "k18r4W_historyLoadingBar",
			"historyLoadingSpinner": "k18r4W_historyLoadingSpinner",
			"inlineResult": "k18r4W_inlineResult",
			"inlineResultText": "k18r4W_inlineResultText",
			"jsonPayload": "k18r4W_jsonPayload",
			"jsonPreview": "k18r4W_jsonPreview",
			"kindSlot": "k18r4W_kindSlot",
			"kindTag": "k18r4W_kindTag",
			"kindTagIcon": "k18r4W_kindTagIcon",
			"kindTagLabel": "k18r4W_kindTagLabel",
			"markdownPayload": "k18r4W_markdownPayload",
			"markdownPreview": "k18r4W_markdownPreview",
			"message": "k18r4W_message",
			"messageImages": "k18r4W_messageImages",
			"messageImagesPreview": "k18r4W_messageImagesPreview",
			"noOutputText": "k18r4W_noOutputText",
			"noPayload": "k18r4W_noPayload",
			"overview": "k18r4W_overview",
			"overviewHeading": "k18r4W_overviewHeading",
			"overviewHierarchyJumpIconTight": "k18r4W_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "k18r4W_overviewHierarchyNavLink",
			"overviewParentLinks": "k18r4W_overviewParentLinks",
			"overviewPreview": "k18r4W_overviewPreview",
			"overviewSection": "k18r4W_overviewSection",
			"overviewSections": "k18r4W_overviewSections",
			"overviewTitle": "k18r4W_overviewTitle",
			"overviewTitleIcon": "k18r4W_overviewTitleIcon",
			"panelImage": "k18r4W_panelImage",
			"panelImageLink": "k18r4W_panelImageLink",
			"panelImageLinkPreview": "k18r4W_panelImageLinkPreview",
			"payload": "k18r4W_payload",
			"payloadPreview": "k18r4W_payloadPreview",
			"promptDiff": "k18r4W_promptDiff",
			"promptDiffLineadded": "k18r4W_promptDiffLineadded",
			"promptDiffLinecontext": "k18r4W_promptDiffLinecontext",
			"promptDiffLinemeta": "k18r4W_promptDiffLinemeta",
			"promptDiffLineremoved": "k18r4W_promptDiffLineremoved",
			"promptDiffSection": "k18r4W_promptDiffSection",
			"promptDiffSections": "k18r4W_promptDiffSections",
			"promptDiffTitle": "k18r4W_promptDiffTitle",
			"requestBoundaryControl": "k18r4W_requestBoundaryControl",
			"requestBoundaryControlActive": "k18r4W_requestBoundaryControlActive",
			"requestDetailsDot": "k18r4W_requestDetailsDot",
			"requestDetailsName": "k18r4W_requestDetailsName",
			"requestTokenDetail": "k18r4W_requestTokenDetail",
			"resultBlockText": "k18r4W_resultBlockText",
			"resultBlocks": "k18r4W_resultBlocks",
			"resultBlocksPreview": "k18r4W_resultBlocksPreview",
			"resultPreview": "k18r4W_resultPreview",
			"resultRequest": "k18r4W_resultRequest",
			"schema": "k18r4W_schema",
			"schemaDescription": "k18r4W_schemaDescription",
			"schemaIntro": "k18r4W_schemaIntro",
			"schemaName": "k18r4W_schemaName",
			"schemaParameters": "k18r4W_schemaParameters",
			"schemaParametersTitle": "k18r4W_schemaParametersTitle",
			"schemaPreview": "k18r4W_schemaPreview",
			"schemaTree": "k18r4W_schemaTree",
			"selectionRail": "k18r4W_selectionRail",
			"sourceBlock": "k18r4W_sourceBlock",
			"sourceBlockContent": "k18r4W_sourceBlockContent",
			"sourceBlockHeader": "k18r4W_sourceBlockHeader",
			"sourceBlockJumpIcon": "k18r4W_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "k18r4W_sourceBlockJumpTarget",
			"sourceBlockLabel": "k18r4W_sourceBlockLabel",
			"sourceBlocks": "k18r4W_sourceBlocks",
			"split": "k18r4W_split",
			"subtoolAmber": "k18r4W_subtoolAmber",
			"summaryScrollRegion": "k18r4W_summaryScrollRegion",
			"systemNeutral": "k18r4W_systemNeutral",
			"systemPrompt": "k18r4W_systemPrompt",
			"table": "k18r4W_table",
			"tablePane": "k18r4W_tablePane",
			"thinkingChevron": "k18r4W_thinkingChevron",
			"thinkingQuote": "k18r4W_thinkingQuote",
			"thinkingQuoteOnlyPreview": "k18r4W_thinkingQuoteOnlyPreview",
			"thinkingToggle": "k18r4W_thinkingToggle",
			"timestampToggle": "k18r4W_timestampToggle",
			"toolAmber": "k18r4W_toolAmber",
			"toolCallNameTypeface": "k18r4W_toolCallNameTypeface",
			"toolCallOnly": "k18r4W_toolCallOnly",
			"toolCallPayload": "k18r4W_toolCallPayload",
			"toolCatalog": "k18r4W_toolCatalog",
			"toolCatalogChevron": "k18r4W_toolCatalogChevron",
			"toolCatalogDefinition": "k18r4W_toolCatalogDefinition",
			"toolCatalogDescription": "k18r4W_toolCatalogDescription",
			"toolCatalogFullDescription": "k18r4W_toolCatalogFullDescription",
			"toolCatalogIcon": "k18r4W_toolCatalogIcon",
			"toolCatalogItem": "k18r4W_toolCatalogItem",
			"toolCatalogName": "k18r4W_toolCatalogName",
			"toolCatalogSummary": "k18r4W_toolCatalogSummary",
			"toolCatalogTree": "k18r4W_toolCatalogTree",
			"trajectory-table": "k18r4W_trajectory-table",
			"turnLabel": "k18r4W_turnLabel",
			"turnLabelActive": "k18r4W_turnLabelActive",
			"turnLabelCompact": "k18r4W_turnLabelCompact",
			"turnLabelFull": "k18r4W_turnLabelFull",
			"turnRail": "k18r4W_turnRail",
			"usageGroup": "k18r4W_usageGroup",
			"usageHeading": "k18r4W_usageHeading",
			"usagePanel": "k18r4W_usagePanel",
			"user": "k18r4W_user",
			"virtualSpacer": "k18r4W_virtualSpacer",
			"visuallyHidden": "k18r4W_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-ab5a0433e27742b99ef765dc97041378\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".KGpmbq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.KGpmbq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.KGpmbq_actions{flex:none;align-items:center;gap:2px;display:flex}.KGpmbq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.KGpmbq_toggle:hover,.KGpmbq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.KGpmbq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.KGpmbq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.KGpmbq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.KGpmbq_control[hidden]{display:none}.KGpmbq_control:hover:not(:disabled),.KGpmbq_control[aria-checked=true],.KGpmbq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.KGpmbq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.KGpmbq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.KGpmbq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.KGpmbq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.KGpmbq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.KGpmbq_controlTrack[data-on=true] .KGpmbq_controlThumb{transform:translate(10px)}.KGpmbq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.KGpmbq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.KGpmbq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.KGpmbq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.KGpmbq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.KGpmbq_search:hover{border-color:var(--dsw-alias-label-caption)}.KGpmbq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.KGpmbq_searchIcon{flex:none}.KGpmbq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.KGpmbq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.KGpmbq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "KGpmbq_action",
			"actionIcon": "KGpmbq_actionIcon",
			"actions": "KGpmbq_actions",
			"control": "KGpmbq_control",
			"controlThumb": "KGpmbq_controlThumb",
			"controlTrack": "KGpmbq_controlTrack",
			"inner": "KGpmbq_inner",
			"root": "KGpmbq_root",
			"search": "KGpmbq_search",
			"searchIcon": "KGpmbq_searchIcon",
			"searchInput": "KGpmbq_searchInput",
			"toggle": "KGpmbq_toggle",
			"toggleIcon": "KGpmbq_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-ab5a0433e27742b99ef765dc97041378\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = ".Hk3WGG_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.Hk3WGG_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.Hk3WGG_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.Hk3WGG_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.Hk3WGG_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.Hk3WGG_labels span:first-child{top:7px}.Hk3WGG_labels span:nth-child(2){top:21px}.Hk3WGG_labels span:nth-child(3){top:35px}.Hk3WGG_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.Hk3WGG_track[data-panning=true]{cursor:grabbing}.Hk3WGG_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.Hk3WGG_earlierHistory:hover{opacity:1}.Hk3WGG_earlierHistory[aria-disabled=true]{cursor:default}.Hk3WGG_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.Hk3WGG_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.Hk3WGG_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Hk3WGG_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.Hk3WGG_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.Hk3WGG_lanes[data-animate-viewport=true],.Hk3WGG_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.Hk3WGG_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.Hk3WGG_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.Hk3WGG_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.Hk3WGG_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.Hk3WGG_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.Hk3WGG_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.Hk3WGG_span[data-timeline-span=tool],.Hk3WGG_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.Hk3WGG_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.Hk3WGG_span[data-equal-duration=true]{width:8px;min-width:8px}.Hk3WGG_span[data-selected=false]{opacity:.2}.Hk3WGG_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.Hk3WGG_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.Hk3WGG_span[data-search-match=false]{opacity:.14}.Hk3WGG_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.Hk3WGG_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.Hk3WGG_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.Hk3WGG_selectionEdges:before,.Hk3WGG_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.Hk3WGG_selectionEdges:before{left:0}.Hk3WGG_selectionEdges:after{right:0}.Hk3WGG_selectionEdges[data-dragging=true]:before,.Hk3WGG_selectionEdges[data-dragging=true]:after{width:2px}.Hk3WGG_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "Hk3WGG_earlierHistory",
			"empty": "Hk3WGG_empty",
			"hoverLine": "Hk3WGG_hoverLine",
			"labels": "Hk3WGG_labels",
			"lanes": "Hk3WGG_lanes",
			"plot": "Hk3WGG_plot",
			"root": "Hk3WGG_root",
			"selection": "Hk3WGG_selection",
			"selectionEdges": "Hk3WGG_selectionEdges",
			"span": "Hk3WGG_span",
			"track": "Hk3WGG_track",
			"turnBoundaries": "Hk3WGG_turnBoundaries",
			"turnBoundary": "Hk3WGG_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-ab5a0433e27742b99ef765dc97041378\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".D3QtJa_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.D3QtJa_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
