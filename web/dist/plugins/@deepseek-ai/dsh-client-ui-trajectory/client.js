window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-9c80724d56484e56a43c2b8dbb125407\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".-Lbjza_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.-Lbjza_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:-Lbjza_trajectory-table/inline-size}.-Lbjza_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.-Lbjza_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.-Lbjza_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite -Lbjza_history-loading-spin}.-Lbjza_table tbody .-Lbjza_historyLoadRow td{height:30px;padding:0}.-Lbjza_table tbody .-Lbjza_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.-Lbjza_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.-Lbjza_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.-Lbjza_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.-Lbjza_historyLoadButton:disabled{cursor:default}.-Lbjza_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.-Lbjza_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes -Lbjza_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.-Lbjza_historyLoadingSpinner{animation:none}}.-Lbjza_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.-Lbjza_eventColumn{width:122px}.-Lbjza_contentColumn{width:auto}.-Lbjza_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.-Lbjza_eventHeader{text-align:right!important;padding-right:4px!important}.-Lbjza_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.-Lbjza_table tbody .-Lbjza_virtualSpacer{pointer-events:none}.-Lbjza_table tbody .-Lbjza_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.-Lbjza_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.-Lbjza_table tbody tr[data-timeline-focus=outside]{opacity:.24}.-Lbjza_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.-Lbjza_table tbody tr[data-request-only=true]:hover{background:0 0}.-Lbjza_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.-Lbjza_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.-Lbjza_table tbody tr[data-request-only=true] .-Lbjza_turnRail{top:-15px;bottom:0}.-Lbjza_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.-Lbjza_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.-Lbjza_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.-Lbjza_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.-Lbjza_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.-Lbjza_requestBoundaryControl:hover:before,.-Lbjza_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.-Lbjza_requestBoundaryControlActive:before,.-Lbjza_requestBoundaryControlActive:hover:before,.-Lbjza_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.-Lbjza_requestBoundaryControl[data-request-status=error]:before,.-Lbjza_requestBoundaryControl[data-request-status=error]:hover:before,.-Lbjza_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.-Lbjza_requestBoundaryControl:hover:after,.-Lbjza_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.-Lbjza_requestBoundaryControl:focus-visible{outline:none}.-Lbjza_table tbody tr:has(.-Lbjza_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.-Lbjza_event{position:relative}.-Lbjza_turnRail,.-Lbjza_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.-Lbjza_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.-Lbjza_table tbody tr[data-turn-end=true] .-Lbjza_turnRail{bottom:0}.-Lbjza_selectionRail{z-index:5;width:3px;top:0;bottom:0}.-Lbjza_table tbody tr[data-error=true] .-Lbjza_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.-Lbjza_table tbody tr[data-error=true] .-Lbjza_selectionRail{background:var(--dsw-alias-state-error-primary)}.-Lbjza_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.-Lbjza_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.-Lbjza_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.-Lbjza_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.-Lbjza_turnLabelFull,.-Lbjza_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.-Lbjza_turnLabelCompact{opacity:0;max-width:0}.-Lbjza_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.-Lbjza_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.-Lbjza_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.-Lbjza_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.-Lbjza_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.-Lbjza_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.-Lbjza_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.-Lbjza_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.-Lbjza_table .-Lbjza_kindSlot .-Lbjza_message{justify-content:center;width:100%}@container -Lbjza_trajectory-table (width<=620px){.-Lbjza_eventColumn{width:50px}.-Lbjza_event{padding-left:28px!important;padding-right:3px!important}.-Lbjza_requestBoundaryControl{--request-boundary-base-left:6px}.-Lbjza_kindSlot{width:19px}.-Lbjza_kindTag,.-Lbjza_table .-Lbjza_kindSlot .-Lbjza_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.-Lbjza_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.-Lbjza_kindTagLabel,.-Lbjza_turnLabelFull{opacity:0;max-width:0}.-Lbjza_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.-Lbjza_eventColumn,.-Lbjza_event,.-Lbjza_requestBoundaryControl,.-Lbjza_kindSlot,.-Lbjza_kindTag,.-Lbjza_kindTagIcon,.-Lbjza_kindTagLabel,.-Lbjza_turnLabelFull,.-Lbjza_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.-Lbjza_eventColumn,.-Lbjza_kindSlot{transition-property:width}.-Lbjza_event{transition-property:padding-right,padding-left}.-Lbjza_requestBoundaryControl{transition-property:left}.-Lbjza_kindTag{transition-property:padding-right,padding-left}.-Lbjza_kindTagIcon{transition-property:width,opacity,transform}.-Lbjza_kindTagLabel,.-Lbjza_turnLabelFull,.-Lbjza_turnLabelCompact{transition-property:max-width,opacity}}.-Lbjza_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.-Lbjza_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.-Lbjza_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.-Lbjza_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.-Lbjza_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.-Lbjza_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.-Lbjza_promptDiffSection{min-width:0}.-Lbjza_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.-Lbjza_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.-Lbjza_promptDiff span{min-width:max-content;padding:0 6px;display:block}.-Lbjza_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.-Lbjza_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.-Lbjza_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.-Lbjza_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.-Lbjza_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.-Lbjza_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.-Lbjza_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.-Lbjza_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.-Lbjza_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.-Lbjza_table tbody tr[data-collapsed-summary=turn] td,.-Lbjza_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.-Lbjza_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.-Lbjza_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.-Lbjza_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.-Lbjza_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.-Lbjza_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.-Lbjza_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.-Lbjza_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.-Lbjza_resultRequest,.-Lbjza_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.-Lbjza_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.-Lbjza_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.-Lbjza_table tbody tr[data-kind=tool] .-Lbjza_contentText,.-Lbjza_table tbody tr[data-kind=subtool] .-Lbjza_contentText,.-Lbjza_table tbody tr[data-kind=tool] .-Lbjza_resultPreview,.-Lbjza_table tbody tr[data-kind=subtool] .-Lbjza_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.-Lbjza_table tbody tr[data-kind=subtool] .-Lbjza_content{padding-left:26px}.-Lbjza_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.-Lbjza_noOutputText{color:var(--dsw-alias-label-caption)}.-Lbjza_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.-Lbjza_error,.-Lbjza_overview dd.-Lbjza_error,.-Lbjza_details .-Lbjza_errorPayload{color:var(--dsw-alias-state-error-primary)}.-Lbjza_details .-Lbjza_errorPayload .-Lbjza_resultBlockText{color:inherit}.-Lbjza_details .-Lbjza_jsonPayload.-Lbjza_errorPayload,.-Lbjza_details .-Lbjza_jsonPreview.-Lbjza_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.-Lbjza_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.-Lbjza_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.-Lbjza_detailsResizeHandle:focus-visible{outline:none}.-Lbjza_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.-Lbjza_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.-Lbjza_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.-Lbjza_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.-Lbjza_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.-Lbjza_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.-Lbjza_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.-Lbjza_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.-Lbjza_detailTabs::-webkit-scrollbar{display:none}.-Lbjza_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.-Lbjza_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.-Lbjza_detailTabActive{color:var(--dsw-alias-state-business-primary)}.-Lbjza_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.-Lbjza_close:focus-visible,.-Lbjza_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.-Lbjza_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.-Lbjza_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.-Lbjza_detailBodySummary>.-Lbjza_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.-Lbjza_detailBodySummary>.-Lbjza_compactedSummary{flex:1;min-height:0;overflow:auto}.-Lbjza_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.-Lbjza_summaryScrollRegion:hover,.-Lbjza_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.-Lbjza_compactedSummary .-Lbjza_markdownPayload{padding-right:18px}.-Lbjza_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.-Lbjza_overviewParentLinks{gap:14px;display:flex}.-Lbjza_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.-Lbjza_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.-Lbjza_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.-Lbjza_overviewHierarchyNavLink:hover .-Lbjza_overviewHierarchyJumpIconTight,.-Lbjza_overviewHierarchyNavLink:focus-visible .-Lbjza_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.-Lbjza_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.-Lbjza_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.-Lbjza_overview>.-Lbjza_requestTokenDetail dt{padding-left:12px}.-Lbjza_usagePanel{padding:4px 0 10px}.-Lbjza_usageGroup+.-Lbjza_usageGroup{margin-top:8px}.-Lbjza_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.-Lbjza_usageGroup .-Lbjza_overview{padding:0}.-Lbjza_overview dt{color:var(--dsw-alias-label-tertiary)}.-Lbjza_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.-Lbjza_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.-Lbjza_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.-Lbjza_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.-Lbjza_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.-Lbjza_overviewSection+.-Lbjza_overviewSection{padding-top:8px}.-Lbjza_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.-Lbjza_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.-Lbjza_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.-Lbjza_overviewTitle:hover .-Lbjza_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.-Lbjza_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.-Lbjza_overviewTitle:focus-visible .-Lbjza_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.-Lbjza_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.-Lbjza_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.-Lbjza_overviewPreview .-Lbjza_jsonPreview>:first-child,.-Lbjza_overviewPreview .-Lbjza_schemaTree>:first-child{padding-bottom:0}.-Lbjza_overviewPreview .-Lbjza_schemaTree{margin-bottom:0}.-Lbjza_overviewPreview .-Lbjza_overview{padding:2px 0 0}.-Lbjza_overviewPreview .-Lbjza_overview>div{min-height:22px}.-Lbjza_markdownPreview,.-Lbjza_markdownPayload{color:var(--dsw-alias-label-primary)}.-Lbjza_markdownPreview>div,.-Lbjza_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.-Lbjza_markdownPreview>div h1,.-Lbjza_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.-Lbjza_markdownPreview>div h2,.-Lbjza_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.-Lbjza_markdownPreview>div :where(h3,h4,h5,h6),.-Lbjza_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.-Lbjza_markdownPreview>div :not(pre)>code,.-Lbjza_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.-Lbjza_markdownPreview>div table,.-Lbjza_markdownPayload>div table{font:var(--dsw-font-xs-13)}.-Lbjza_markdownPreview>div>:first-child{margin-top:0}.-Lbjza_markdownPreview>div>:last-child{margin-bottom:0}.-Lbjza_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.-Lbjza_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.-Lbjza_markdownPreview>div :where(p,ul,ol){margin:8px 0}.-Lbjza_markdownPreview>div li:not(:first-child){margin-top:3px}.-Lbjza_markdownPreview>div blockquote{margin-top:8px}.-Lbjza_markdownPreview>div hr{margin:14px 0}.-Lbjza_markdownPreview>div>.md-code-block{margin:10px 0}.-Lbjza_assistantContent .-Lbjza_markdownPayload,.-Lbjza_assistantContent .-Lbjza_payload{min-height:0}.-Lbjza_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.-Lbjza_thinkingQuoteOnlyPreview{margin-bottom:8px}.-Lbjza_detailBody>.-Lbjza_assistantContentRendered .-Lbjza_thinkingQuote{margin-top:14px}.-Lbjza_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.-Lbjza_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.-Lbjza_thinkingToggle[aria-expanded=true] .-Lbjza_thinkingChevron{transform:rotate(90deg)}.-Lbjza_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.-Lbjza_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.-Lbjza_thinkingQuote .-Lbjza_markdownPreview,.-Lbjza_thinkingQuote .-Lbjza_markdownPayload,.-Lbjza_thinkingQuote .-Lbjza_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.-Lbjza_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.-Lbjza_markdownPreview{padding:6px 14px 8px}.-Lbjza_markdownPayload{min-height:100%;padding:14px}.-Lbjza_jsonPayload{min-height:100%}.-Lbjza_jsonPreview{min-height:0}.-Lbjza_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.-Lbjza_schemaPreview{min-height:0}.-Lbjza_schemaIntro{padding:12px 14px 6px}.-Lbjza_schemaPreview .-Lbjza_schemaIntro{padding-top:6px}.-Lbjza_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.-Lbjza_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.-Lbjza_schemaParameters{min-width:0}.-Lbjza_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.-Lbjza_schemaTree{margin:0 6px 8px 0}.-Lbjza_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.-Lbjza_payloadPreview{min-height:0;padding:6px 14px 8px}.-Lbjza_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.-Lbjza_sourceBlock+.-Lbjza_sourceBlock{margin-top:14px}.-Lbjza_sourceBlockHeader,.-Lbjza_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.-Lbjza_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.-Lbjza_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.-Lbjza_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.-Lbjza_sourceBlockJumpTarget:hover .-Lbjza_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.-Lbjza_sourceBlockJumpTarget:focus-visible{outline:none}.-Lbjza_sourceBlockJumpTarget:focus-visible .-Lbjza_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.-Lbjza_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.-Lbjza_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.-Lbjza_panelImageLinkPreview{max-height:140px}.-Lbjza_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.-Lbjza_panelImageLinkPreview .-Lbjza_panelImage{max-height:140px}.-Lbjza_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.-Lbjza_messageImagesPreview{gap:6px;margin:6px 14px 8px}.-Lbjza_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.-Lbjza_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.-Lbjza_assistantToolCalls li{min-width:0}.-Lbjza_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.-Lbjza_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.-Lbjza_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.-Lbjza_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.-Lbjza_assistantToolCallButton:hover .-Lbjza_assistantToolCallIcon,.-Lbjza_assistantToolCallButton:focus-visible .-Lbjza_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.-Lbjza_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.-Lbjza_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.-Lbjza_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.-Lbjza_systemPrompt{box-sizing:border-box}.-Lbjza_toolCatalog{min-height:100%;padding:8px 0 16px}.-Lbjza_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.-Lbjza_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.-Lbjza_toolCatalogSummary::-webkit-details-marker{display:none}.-Lbjza_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.-Lbjza_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.-Lbjza_toolCatalogChevron,.-Lbjza_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.-Lbjza_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.-Lbjza_toolCatalogItem[open] .-Lbjza_toolCatalogChevron{transform:rotate(90deg)}.-Lbjza_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.-Lbjza_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.-Lbjza_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.-Lbjza_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.-Lbjza_toolCatalogTree{margin-left:-14px;margin-right:6px}.-Lbjza_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.-Lbjza_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.-Lbjza_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.-Lbjza_overviewPreview .-Lbjza_noPayload{padding:6px 14px 8px}.-Lbjza_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.-Lbjza_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "-Lbjza_arrow",
			"assistantContent": "-Lbjza_assistantContent",
			"assistantContentRendered": "-Lbjza_assistantContentRendered",
			"assistantOutput": "-Lbjza_assistantOutput",
			"assistantToolCallArgs": "-Lbjza_assistantToolCallArgs",
			"assistantToolCallButton": "-Lbjza_assistantToolCallButton",
			"assistantToolCallIcon": "-Lbjza_assistantToolCallIcon",
			"assistantToolCallName": "-Lbjza_assistantToolCallName",
			"assistantToolCallText": "-Lbjza_assistantToolCallText",
			"assistantToolCalls": "-Lbjza_assistantToolCalls",
			"assistantToolCallsPreview": "-Lbjza_assistantToolCallsPreview",
			"assistantVioletBright": "-Lbjza_assistantVioletBright",
			"close": "-Lbjza_close",
			"collapsedTurnContent": "-Lbjza_collapsedTurnContent",
			"collapsedTurnEllipsis": "-Lbjza_collapsedTurnEllipsis",
			"collapsedTurnText": "-Lbjza_collapsedTurnText",
			"compacted": "-Lbjza_compacted",
			"compactedSummary": "-Lbjza_compactedSummary",
			"content": "-Lbjza_content",
			"contentColumn": "-Lbjza_contentColumn",
			"contentText": "-Lbjza_contentText",
			"contextGreen": "-Lbjza_contextGreen",
			"detailBody": "-Lbjza_detailBody",
			"detailBodySummary": "-Lbjza_detailBodySummary",
			"detailTab": "-Lbjza_detailTab",
			"detailTabActive": "-Lbjza_detailTabActive",
			"detailTabs": "-Lbjza_detailTabs",
			"details": "-Lbjza_details",
			"detailsHeader": "-Lbjza_detailsHeader",
			"detailsLocation": "-Lbjza_detailsLocation",
			"detailsResizeHandle": "-Lbjza_detailsResizeHandle",
			"detailsTitle": "-Lbjza_detailsTitle",
			"error": "-Lbjza_error",
			"errorPayload": "-Lbjza_errorPayload",
			"event": "-Lbjza_event",
			"eventColumn": "-Lbjza_eventColumn",
			"eventHeader": "-Lbjza_eventHeader",
			"eventInner": "-Lbjza_eventInner",
			"history-loading-spin": "-Lbjza_history-loading-spin",
			"historyLoadButton": "-Lbjza_historyLoadButton",
			"historyLoadRow": "-Lbjza_historyLoadRow",
			"historyLoading": "-Lbjza_historyLoading",
			"historyLoadingBar": "-Lbjza_historyLoadingBar",
			"historyLoadingSpinner": "-Lbjza_historyLoadingSpinner",
			"inlineResult": "-Lbjza_inlineResult",
			"inlineResultText": "-Lbjza_inlineResultText",
			"jsonPayload": "-Lbjza_jsonPayload",
			"jsonPreview": "-Lbjza_jsonPreview",
			"kindSlot": "-Lbjza_kindSlot",
			"kindTag": "-Lbjza_kindTag",
			"kindTagIcon": "-Lbjza_kindTagIcon",
			"kindTagLabel": "-Lbjza_kindTagLabel",
			"markdownPayload": "-Lbjza_markdownPayload",
			"markdownPreview": "-Lbjza_markdownPreview",
			"message": "-Lbjza_message",
			"messageImages": "-Lbjza_messageImages",
			"messageImagesPreview": "-Lbjza_messageImagesPreview",
			"noOutputText": "-Lbjza_noOutputText",
			"noPayload": "-Lbjza_noPayload",
			"overview": "-Lbjza_overview",
			"overviewHeading": "-Lbjza_overviewHeading",
			"overviewHierarchyJumpIconTight": "-Lbjza_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "-Lbjza_overviewHierarchyNavLink",
			"overviewParentLinks": "-Lbjza_overviewParentLinks",
			"overviewPreview": "-Lbjza_overviewPreview",
			"overviewSection": "-Lbjza_overviewSection",
			"overviewSections": "-Lbjza_overviewSections",
			"overviewTitle": "-Lbjza_overviewTitle",
			"overviewTitleIcon": "-Lbjza_overviewTitleIcon",
			"panelImage": "-Lbjza_panelImage",
			"panelImageLink": "-Lbjza_panelImageLink",
			"panelImageLinkPreview": "-Lbjza_panelImageLinkPreview",
			"payload": "-Lbjza_payload",
			"payloadPreview": "-Lbjza_payloadPreview",
			"promptDiff": "-Lbjza_promptDiff",
			"promptDiffLineadded": "-Lbjza_promptDiffLineadded",
			"promptDiffLinecontext": "-Lbjza_promptDiffLinecontext",
			"promptDiffLinemeta": "-Lbjza_promptDiffLinemeta",
			"promptDiffLineremoved": "-Lbjza_promptDiffLineremoved",
			"promptDiffSection": "-Lbjza_promptDiffSection",
			"promptDiffSections": "-Lbjza_promptDiffSections",
			"promptDiffTitle": "-Lbjza_promptDiffTitle",
			"requestBoundaryControl": "-Lbjza_requestBoundaryControl",
			"requestBoundaryControlActive": "-Lbjza_requestBoundaryControlActive",
			"requestDetailsDot": "-Lbjza_requestDetailsDot",
			"requestDetailsName": "-Lbjza_requestDetailsName",
			"requestTokenDetail": "-Lbjza_requestTokenDetail",
			"resultBlockText": "-Lbjza_resultBlockText",
			"resultBlocks": "-Lbjza_resultBlocks",
			"resultBlocksPreview": "-Lbjza_resultBlocksPreview",
			"resultPreview": "-Lbjza_resultPreview",
			"resultRequest": "-Lbjza_resultRequest",
			"schema": "-Lbjza_schema",
			"schemaDescription": "-Lbjza_schemaDescription",
			"schemaIntro": "-Lbjza_schemaIntro",
			"schemaName": "-Lbjza_schemaName",
			"schemaParameters": "-Lbjza_schemaParameters",
			"schemaParametersTitle": "-Lbjza_schemaParametersTitle",
			"schemaPreview": "-Lbjza_schemaPreview",
			"schemaTree": "-Lbjza_schemaTree",
			"selectionRail": "-Lbjza_selectionRail",
			"sourceBlock": "-Lbjza_sourceBlock",
			"sourceBlockContent": "-Lbjza_sourceBlockContent",
			"sourceBlockHeader": "-Lbjza_sourceBlockHeader",
			"sourceBlockJumpIcon": "-Lbjza_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "-Lbjza_sourceBlockJumpTarget",
			"sourceBlockLabel": "-Lbjza_sourceBlockLabel",
			"sourceBlocks": "-Lbjza_sourceBlocks",
			"split": "-Lbjza_split",
			"subtoolAmber": "-Lbjza_subtoolAmber",
			"summaryScrollRegion": "-Lbjza_summaryScrollRegion",
			"systemNeutral": "-Lbjza_systemNeutral",
			"systemPrompt": "-Lbjza_systemPrompt",
			"table": "-Lbjza_table",
			"tablePane": "-Lbjza_tablePane",
			"thinkingChevron": "-Lbjza_thinkingChevron",
			"thinkingQuote": "-Lbjza_thinkingQuote",
			"thinkingQuoteOnlyPreview": "-Lbjza_thinkingQuoteOnlyPreview",
			"thinkingToggle": "-Lbjza_thinkingToggle",
			"timestampToggle": "-Lbjza_timestampToggle",
			"toolAmber": "-Lbjza_toolAmber",
			"toolCallNameTypeface": "-Lbjza_toolCallNameTypeface",
			"toolCallOnly": "-Lbjza_toolCallOnly",
			"toolCallPayload": "-Lbjza_toolCallPayload",
			"toolCatalog": "-Lbjza_toolCatalog",
			"toolCatalogChevron": "-Lbjza_toolCatalogChevron",
			"toolCatalogDefinition": "-Lbjza_toolCatalogDefinition",
			"toolCatalogDescription": "-Lbjza_toolCatalogDescription",
			"toolCatalogFullDescription": "-Lbjza_toolCatalogFullDescription",
			"toolCatalogIcon": "-Lbjza_toolCatalogIcon",
			"toolCatalogItem": "-Lbjza_toolCatalogItem",
			"toolCatalogName": "-Lbjza_toolCatalogName",
			"toolCatalogSummary": "-Lbjza_toolCatalogSummary",
			"toolCatalogTree": "-Lbjza_toolCatalogTree",
			"trajectory-table": "-Lbjza_trajectory-table",
			"turnLabel": "-Lbjza_turnLabel",
			"turnLabelActive": "-Lbjza_turnLabelActive",
			"turnLabelCompact": "-Lbjza_turnLabelCompact",
			"turnLabelFull": "-Lbjza_turnLabelFull",
			"turnRail": "-Lbjza_turnRail",
			"usageGroup": "-Lbjza_usageGroup",
			"usageHeading": "-Lbjza_usageHeading",
			"usagePanel": "-Lbjza_usagePanel",
			"user": "-Lbjza_user",
			"virtualSpacer": "-Lbjza_virtualSpacer",
			"visuallyHidden": "-Lbjza_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-9c80724d56484e56a43c2b8dbb125407\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".cnZbhq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.cnZbhq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.cnZbhq_actions{flex:none;align-items:center;gap:2px;display:flex}.cnZbhq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.cnZbhq_toggle:hover,.cnZbhq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.cnZbhq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cnZbhq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.cnZbhq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.cnZbhq_control[hidden]{display:none}.cnZbhq_control:hover:not(:disabled),.cnZbhq_control[aria-checked=true],.cnZbhq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.cnZbhq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cnZbhq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.cnZbhq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.cnZbhq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.cnZbhq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.cnZbhq_controlTrack[data-on=true] .cnZbhq_controlThumb{transform:translate(10px)}.cnZbhq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.cnZbhq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.cnZbhq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cnZbhq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.cnZbhq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.cnZbhq_search:hover{border-color:var(--dsw-alias-label-caption)}.cnZbhq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.cnZbhq_searchIcon{flex:none}.cnZbhq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.cnZbhq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.cnZbhq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "cnZbhq_action",
			"actionIcon": "cnZbhq_actionIcon",
			"actions": "cnZbhq_actions",
			"control": "cnZbhq_control",
			"controlThumb": "cnZbhq_controlThumb",
			"controlTrack": "cnZbhq_controlTrack",
			"inner": "cnZbhq_inner",
			"root": "cnZbhq_root",
			"search": "cnZbhq_search",
			"searchIcon": "cnZbhq_searchIcon",
			"searchInput": "cnZbhq_searchInput",
			"toggle": "cnZbhq_toggle",
			"toggleIcon": "cnZbhq_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-9c80724d56484e56a43c2b8dbb125407\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = ".I1xWCa_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.I1xWCa_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.I1xWCa_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.I1xWCa_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.I1xWCa_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.I1xWCa_labels span:first-child{top:7px}.I1xWCa_labels span:nth-child(2){top:21px}.I1xWCa_labels span:nth-child(3){top:35px}.I1xWCa_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.I1xWCa_track[data-panning=true]{cursor:grabbing}.I1xWCa_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.I1xWCa_earlierHistory:hover{opacity:1}.I1xWCa_earlierHistory[aria-disabled=true]{cursor:default}.I1xWCa_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.I1xWCa_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.I1xWCa_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.I1xWCa_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.I1xWCa_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.I1xWCa_lanes[data-animate-viewport=true],.I1xWCa_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.I1xWCa_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.I1xWCa_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.I1xWCa_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.I1xWCa_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.I1xWCa_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.I1xWCa_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.I1xWCa_span[data-timeline-span=tool],.I1xWCa_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.I1xWCa_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.I1xWCa_span[data-equal-duration=true]{width:8px;min-width:8px}.I1xWCa_span[data-selected=false]{opacity:.2}.I1xWCa_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.I1xWCa_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.I1xWCa_span[data-search-match=false]{opacity:.14}.I1xWCa_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.I1xWCa_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.I1xWCa_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.I1xWCa_selectionEdges:before,.I1xWCa_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.I1xWCa_selectionEdges:before{left:0}.I1xWCa_selectionEdges:after{right:0}.I1xWCa_selectionEdges[data-dragging=true]:before,.I1xWCa_selectionEdges[data-dragging=true]:after{width:2px}.I1xWCa_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "I1xWCa_earlierHistory",
			"empty": "I1xWCa_empty",
			"hoverLine": "I1xWCa_hoverLine",
			"labels": "I1xWCa_labels",
			"lanes": "I1xWCa_lanes",
			"plot": "I1xWCa_plot",
			"root": "I1xWCa_root",
			"selection": "I1xWCa_selection",
			"selectionEdges": "I1xWCa_selectionEdges",
			"span": "I1xWCa_span",
			"track": "I1xWCa_track",
			"turnBoundaries": "I1xWCa_turnBoundaries",
			"turnBoundary": "I1xWCa_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-9c80724d56484e56a43c2b8dbb125407\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = "._nEHHW_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}._nEHHW_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
