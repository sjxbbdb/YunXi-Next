window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-attachment\src\AttachmentRail.module.css.mjs
		const css$4 = ".QA0_Iq_root{min-width:0;position:relative}.QA0_Iq_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:10px;display:flex;overflow:auto hidden}.QA0_Iq_rail::-webkit-scrollbar{display:none}.QA0_Iq_item{flex:0 0 64px;width:64px;height:64px;position:relative}.QA0_Iq_thumbnail{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.QA0_Iq_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.QA0_Iq_remove{z-index:1;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.QA0_Iq_item:hover .QA0_Iq_remove,.QA0_Iq_remove:focus-visible{opacity:1}@media (pointer:coarse){.QA0_Iq_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.QA0_Iq_remove{transition:none}}.QA0_Iq_arrow{z-index:2;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.QA0_Iq_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.QA0_Iq_arrowLeft{left:4px}.QA0_Iq_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "QA0_Iq_arrow",
			"arrowLeft": "QA0_Iq_arrowLeft",
			"arrowRight": "QA0_Iq_arrowRight",
			"item": "QA0_Iq_item",
			"rail": "QA0_Iq_rail",
			"remove": "QA0_Iq_remove",
			"root": "QA0_Iq_root",
			"thumbnail": "QA0_Iq_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-attachment\src\DropOverlay.module.css.mjs
		const css$3 = ".BOFXDq_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out BOFXDq_fade-in;display:flex;position:fixed;inset:0}@keyframes BOFXDq_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){.BOFXDq_mask{animation:none}}.BOFXDq_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}.BOFXDq_illustration{width:115px;height:84px}.BOFXDq_title{font:var(--dsw-font-l-20);margin-top:16px}.BOFXDq_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "BOFXDq_desc",
			"fade-in": "BOFXDq_fade-in",
			"illustration": "BOFXDq_illustration",
			"mask": "BOFXDq_mask",
			"title": "BOFXDq_title",
			"wrap": "BOFXDq_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-attachment\src\ImageLightbox.module.css.mjs
		const css$2 = ".Vtauaq_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.Vtauaq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.Vtauaq_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.Vtauaq_close{z-index:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-attachment\src\client\ComposerAttachments.module.css.mjs
		const css$1 = "._2W_GLW_rail{min-width:0;padding:4px 12px 0}";
		...
		var ComposerAttachments_module_css_default = { "rail": "_2W_GLW_rail" };
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-attachment\src\MessageImage.module.css.mjs
		const css = ".Fs2eDq_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}.Fs2eDq_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}.Fs2eDq_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}.Fs2eDq_frame{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}.Fs2eDq_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}.Fs2eDq_frame img{object-fit:cover;width:100%;height:100%;display:block}.Fs2eDq_loading,.Fs2eDq_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.Fs2eDq_error{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}.Fs2eDq_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "Fs2eDq_error",
			"frame": "Fs2eDq_frame",
			"gallery": "Fs2eDq_gallery",
			"loading": "Fs2eDq_loading"
		};
		//#endregion
