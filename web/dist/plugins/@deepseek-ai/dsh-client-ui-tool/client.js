window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-1b724c4edaa94137b565704a3acef4c3\packages\client\ui-tool\src\client\tool\components\ToolRow.module.css.mjs
		const css$3 = ".uIhzjG_root{flex-direction:column;display:flex}.uIhzjG_row{position:relative;overflow:hidden}.uIhzjG_root[data-state=running] .uIhzjG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite uIhzjG_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes uIhzjG_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.uIhzjG_leading{flex-shrink:0}.uIhzjG_root[data-tool^=cordis_] .uIhzjG_leading,.uIhzjG_root[data-tool^=cordis_] .uIhzjG_title{color:var(--dsw-alias-state-business-primary)}.uIhzjG_root[data-tool^=cordis_] .uIhzjG_title{font-weight:500}.uIhzjG_root[data-tool^=cordis_] .uIhzjG_sep{background:var(--dsw-alias-state-business-primary)}.uIhzjG_chevron{color:var(--dsw-alias-label-secondary)}.uIhzjG_title{font-weight:400}.uIhzjG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.uIhzjG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.uIhzjG_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.uIhzjG_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.uIhzjG_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.uIhzjG_errorSummary{color:var(--dsw-alias-state-error-primary)}.uIhzjG_bodyWrap{flex-direction:column;display:flex}.uIhzjG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.uIhzjG_root:hover .uIhzjG_inspectButton,.uIhzjG_inspectButton:focus-visible{opacity:1}.uIhzjG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.uIhzjG_bodyScroll{max-height:260px;overflow-y:auto}.uIhzjG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.uIhzjG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.uIhzjG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.uIhzjG_ioSection::-webkit-scrollbar-track{margin:6px 0}.uIhzjG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.uIhzjG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.uIhzjG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.uIhzjG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.uIhzjG_codeBody,.uIhzjG_terminalBody,.uIhzjG_diffBody,.uIhzjG_readBody,.uIhzjG_searchBody,.uIhzjG_webBody{margin:4px 0 4px 4px}.uIhzjG_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.uIhzjG_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.uIhzjG_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.uIhzjG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "uIhzjG_bodyScroll",
			"bodyWrap": "uIhzjG_bodyWrap",
			"chevron": "uIhzjG_chevron",
			"codeBody": "uIhzjG_codeBody",
			"diffBody": "uIhzjG_diffBody",
			"dsh-tool-row-sweep": "uIhzjG_dsh-tool-row-sweep",
			"errorSummary": "uIhzjG_errorSummary",
			"fileLink": "uIhzjG_fileLink",
			"inspectButton": "uIhzjG_inspectButton",
			"ioCard": "uIhzjG_ioCard",
			"ioDivider": "uIhzjG_ioDivider",
			"ioLabel": "uIhzjG_ioLabel",
			"ioSection": "uIhzjG_ioSection",
			"ioText": "uIhzjG_ioText",
			"leading": "uIhzjG_leading",
			"readBody": "uIhzjG_readBody",
			"root": "uIhzjG_root",
			"row": "uIhzjG_row",
			"searchBody": "uIhzjG_searchBody",
			"searchRecovery": "uIhzjG_searchRecovery",
			"sep": "uIhzjG_sep",
			"summary": "uIhzjG_summary",
			"summarySuffix": "uIhzjG_summarySuffix",
			"terminalBody": "uIhzjG_terminalBody",
			"title": "uIhzjG_title",
			"visuallyHidden": "uIhzjG_visuallyHidden",
			"webBody": "uIhzjG_webBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-1b724c4edaa94137b565704a3acef4c3\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".DTIcrW_callRow{border-radius:6px}.DTIcrW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "DTIcrW_callRow",
			"subCalls": "DTIcrW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-1b724c4edaa94137b565704a3acef4c3\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".eUv5IG_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.eUv5IG_cardBody{margin:0}.eUv5IG_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.eUv5IG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.eUv5IG_code[data-error]{color:var(--dsw-alias-state-error-primary)}.eUv5IG_read,.eUv5IG_web{margin:0}.eUv5IG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "eUv5IG_cardBody",
			"code": "eUv5IG_code",
			"description": "eUv5IG_description",
			"empty": "eUv5IG_empty",
			"read": "eUv5IG_read",
			"recovery": "eUv5IG_recovery",
			"web": "eUv5IG_web"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-1b724c4edaa94137b565704a3acef4c3\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = ".R3S7WW_card{flex-direction:column;display:flex}.R3S7WW_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.R3S7WW_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.R3S7WW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.R3S7WW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.R3S7WW_ioSection::-webkit-scrollbar-track{margin:6px 0}.R3S7WW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.R3S7WW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.R3S7WW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.R3S7WW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.R3S7WW_root[data-expandable]{cursor:pointer}.R3S7WW_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.R3S7WW_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite R3S7WW_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes R3S7WW_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.R3S7WW_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.R3S7WW_chevron{color:var(--dsw-alias-label-secondary)}.R3S7WW_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.R3S7WW_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.R3S7WW_root:hover .R3S7WW_iconIdle{opacity:0}.R3S7WW_root:hover .R3S7WW_chevronHover{opacity:1}.R3S7WW_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.R3S7WW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.R3S7WW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.R3S7WW_errorSummary{color:var(--dsw-alias-state-error-primary)}.R3S7WW_bodyWrap{flex-direction:column;display:flex}.R3S7WW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.R3S7WW_card:hover .R3S7WW_inspectButton,.R3S7WW_inspectButton:focus-visible{opacity:1}.R3S7WW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.R3S7WW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "R3S7WW_bodyWrap",
			"card": "R3S7WW_card",
			"chevron": "R3S7WW_chevron",
			"chevronHover": "R3S7WW_chevronHover",
			"dsh-bash-row-sweep": "R3S7WW_dsh-bash-row-sweep",
			"errorSummary": "R3S7WW_errorSummary",
			"iconIdle": "R3S7WW_iconIdle",
			"inspectButton": "R3S7WW_inspectButton",
			"ioCard": "R3S7WW_ioCard",
			"ioDivider": "R3S7WW_ioDivider",
			"ioLabel": "R3S7WW_ioLabel",
			"ioSection": "R3S7WW_ioSection",
			"ioText": "R3S7WW_ioText",
			"leading": "R3S7WW_leading",
			"root": "R3S7WW_root",
			"sep": "R3S7WW_sep",
			"summary": "R3S7WW_summary",
			"terminal": "R3S7WW_terminal",
			"title": "R3S7WW_title",
			"visuallyHidden": "R3S7WW_visuallyHidden"
		};
		//#endregion
