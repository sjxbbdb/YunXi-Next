window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-model-selection\src\client\ModelSelect.module.css.mjs
		const css = ".Z9-kPq_root{min-width:0;position:relative}.Z9-kPq_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.Z9-kPq_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Z9-kPq_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.Z9-kPq_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Z9-kPq_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Z9-kPq_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.Z9-kPq_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.Z9-kPq_chevronOpen{transform:rotate(180deg)}.Z9-kPq_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.Z9-kPq_status,.Z9-kPq_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.Z9-kPq_error,.Z9-kPq_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.Z9-kPq_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.Z9-kPq_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.Z9-kPq_groups{min-height:0;overflow-y:auto}.Z9-kPq_group+.Z9-kPq_group{margin-top:4px}.Z9-kPq_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.Z9-kPq_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.Z9-kPq_option:hover:not(:disabled),.Z9-kPq_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.Z9-kPq_selected{background:0 0}.Z9-kPq_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.Z9-kPq_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Z9-kPq_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.Z9-kPq_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.Z9-kPq_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.Z9-kPq_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.Z9-kPq_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.Z9-kPq_cellLabel{white-space:nowrap;flex:none}.Z9-kPq_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.Z9-kPq_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "Z9-kPq_cell",
			"cellChevron": "Z9-kPq_cellChevron",
			"cellLabel": "Z9-kPq_cellLabel",
			"cellValue": "Z9-kPq_cellValue",
			"check": "Z9-kPq_check",
			"chevron": "Z9-kPq_chevron",
			"chevronOpen": "Z9-kPq_chevronOpen",
			"description": "Z9-kPq_description",
			"empty": "Z9-kPq_empty",
			"error": "Z9-kPq_error",
			"group": "Z9-kPq_group",
			"groupTitle": "Z9-kPq_groupTitle",
			"groups": "Z9-kPq_groups",
			"menu": "Z9-kPq_menu",
			"modelName": "Z9-kPq_modelName",
			"option": "Z9-kPq_option",
			"optionCopy": "Z9-kPq_optionCopy",
			"retry": "Z9-kPq_retry",
			"root": "Z9-kPq_root",
			"selected": "Z9-kPq_selected",
			"status": "Z9-kPq_status",
			"trigger": "Z9-kPq_trigger",
			"triggerEffort": "Z9-kPq_triggerEffort",
			"triggerLabel": "Z9-kPq_triggerLabel",
			"warning": "Z9-kPq_warning"
		};
		//#endregion
