window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-1b724c4edaa94137b565704a3acef4c3\packages\client\ui-model-selection\src\client\ModelSelect.module.css.mjs
		const css = ".xnc-da_root{min-width:0;position:relative}.xnc-da_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.xnc-da_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.xnc-da_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.xnc-da_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.xnc-da_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.xnc-da_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.xnc-da_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.xnc-da_chevronOpen{transform:rotate(180deg)}.xnc-da_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.xnc-da_status,.xnc-da_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.xnc-da_error,.xnc-da_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.xnc-da_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.xnc-da_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.xnc-da_groups{min-height:0;overflow-y:auto}.xnc-da_group+.xnc-da_group{margin-top:4px}.xnc-da_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.xnc-da_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.xnc-da_option:hover:not(:disabled),.xnc-da_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.xnc-da_selected{background:0 0}.xnc-da_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.xnc-da_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.xnc-da_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.xnc-da_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.xnc-da_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.xnc-da_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.xnc-da_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.xnc-da_cellLabel{white-space:nowrap;flex:none}.xnc-da_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.xnc-da_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "xnc-da_cell",
			"cellChevron": "xnc-da_cellChevron",
			"cellLabel": "xnc-da_cellLabel",
			"cellValue": "xnc-da_cellValue",
			"check": "xnc-da_check",
			"chevron": "xnc-da_chevron",
			"chevronOpen": "xnc-da_chevronOpen",
			"description": "xnc-da_description",
			"empty": "xnc-da_empty",
			"error": "xnc-da_error",
			"group": "xnc-da_group",
			"groupTitle": "xnc-da_groupTitle",
			"groups": "xnc-da_groups",
			"menu": "xnc-da_menu",
			"modelName": "xnc-da_modelName",
			"option": "xnc-da_option",
			"optionCopy": "xnc-da_optionCopy",
			"retry": "xnc-da_retry",
			"root": "xnc-da_root",
			"selected": "xnc-da_selected",
			"status": "xnc-da_status",
			"trigger": "xnc-da_trigger",
			"triggerEffort": "xnc-da_triggerEffort",
			"triggerLabel": "xnc-da_triggerLabel",
			"warning": "xnc-da_warning"
		};
		//#endregion
