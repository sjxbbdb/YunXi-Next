window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-skill\src\client\SkillRow.module.css.mjs
		const css = ".Tpa0Bq_card{flex-direction:column;display:flex}.Tpa0Bq_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.Tpa0Bq_row[data-expandable]{cursor:pointer}.Tpa0Bq_card[data-state=running] .Tpa0Bq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite Tpa0Bq_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes Tpa0Bq_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.Tpa0Bq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.Tpa0Bq_chevron{color:var(--dsw-alias-label-secondary)}.Tpa0Bq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.Tpa0Bq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.Tpa0Bq_row:hover .Tpa0Bq_iconIdle{opacity:0}.Tpa0Bq_row:hover .Tpa0Bq_chevronHover{opacity:1}.Tpa0Bq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.Tpa0Bq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Tpa0Bq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.Tpa0Bq_errorSummary{color:var(--dsw-alias-state-error-primary)}.Tpa0Bq_bodyWrap{flex-direction:column;display:flex}.Tpa0Bq_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.Tpa0Bq_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.Tpa0Bq_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.Tpa0Bq_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.Tpa0Bq_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.Tpa0Bq_instructions::-webkit-scrollbar-track{margin:6px 0}.Tpa0Bq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.Tpa0Bq_card:hover .Tpa0Bq_inspectButton,.Tpa0Bq_inspectButton:focus-visible{opacity:1}.Tpa0Bq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.Tpa0Bq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.Tpa0Bq_card[data-state=running] .Tpa0Bq_row:after{animation:none;display:none}.Tpa0Bq_iconIdle,.Tpa0Bq_chevronHover,.Tpa0Bq_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "Tpa0Bq_bodyWrap",
			"card": "Tpa0Bq_card",
			"chevron": "Tpa0Bq_chevron",
			"chevronHover": "Tpa0Bq_chevronHover",
			"dsh-skill-row-sweep": "Tpa0Bq_dsh-skill-row-sweep",
			"errorSummary": "Tpa0Bq_errorSummary",
			"iconIdle": "Tpa0Bq_iconIdle",
			"inspectButton": "Tpa0Bq_inspectButton",
			"instructions": "Tpa0Bq_instructions",
			"instructionsCard": "Tpa0Bq_instructionsCard",
			"instructionsHeader": "Tpa0Bq_instructionsHeader",
			"leading": "Tpa0Bq_leading",
			"row": "Tpa0Bq_row",
			"separator": "Tpa0Bq_separator",
			"summary": "Tpa0Bq_summary",
			"title": "Tpa0Bq_title",
			"visuallyHidden": "Tpa0Bq_visuallyHidden"
		};
		//#endregion
