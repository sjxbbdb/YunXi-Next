window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-fc075cf71c884b4081d88130d74886d7\packages\client\ui-settings-plugin-inventory\src\client\PluginInventorySettingsTab.module.css.mjs
		const css = ".CAMRWW_section{box-sizing:border-box;width:100%;min-width:0;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}.CAMRWW_catalogHeading h3,.CAMRWW_status,.CAMRWW_failure p{margin:0}.CAMRWW_status,.CAMRWW_failure{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.CAMRWW_writeError{color:var(--dsw-alias-state-error-primary);margin:0;font-size:13px;line-height:20px}.CAMRWW_failure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;display:flex}.CAMRWW_failure button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:4px 10px}.CAMRWW_catalog{flex-direction:column;gap:12px;min-width:0;display:flex}.CAMRWW_search{width:100%;color:var(--dsw-alias-label-tertiary);align-items:center;display:flex;position:relative}.CAMRWW_search>svg{pointer-events:none;position:absolute;left:12px}.CAMRWW_search input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:36px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;outline:none;padding:0 34px 0 36px;font-size:13px}.CAMRWW_search input::placeholder{color:var(--dsw-alias-label-tertiary)}.CAMRWW_search input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.CAMRWW_catalogHeading{align-items:baseline;gap:7px;padding:0 2px;display:flex}.CAMRWW_catalogHeading h3{font-size:13px;font-weight:600;line-height:20px}.CAMRWW_catalogHeading span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.CAMRWW_cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;min-width:0;margin:0;padding:0;list-style:none;display:grid}.CAMRWW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:8px;min-width:0;overflow:hidden}.CAMRWW_card[data-open=true]{border-color:var(--dsw-alias-border-l1);box-shadow:var(--dsw-shadow-lv1)}.CAMRWW_cardHeader{align-items:center;min-width:0;display:flex}.CAMRWW_cardContent{box-sizing:border-box;min-width:0;min-height:52px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex:auto;justify-content:space-between;align-items:center;gap:10px;padding:12px 8px 12px 14px;display:flex}.CAMRWW_cardContent:hover,.CAMRWW_card[data-open=true] .CAMRWW_cardContent{background:var(--dsw-alias-interactive-bg-hover)}.CAMRWW_cardContent:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.CAMRWW_cardTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;font-weight:600;line-height:20px;overflow:hidden}.CAMRWW_cardTrailing{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:6px;display:inline-flex}.CAMRWW_statusDot{background:var(--dsw-alias-label-tertiary);border-radius:999px;flex:none;width:7px;height:7px;display:inline-block}.CAMRWW_statusDot[data-phase=active]{background:var(--dsw-alias-state-success-primary)}.CAMRWW_statusDot[data-phase=failed]{background:var(--dsw-alias-state-error-primary)}.CAMRWW_statusDot[data-phase=loading]{background:var(--dsw-alias-state-business-primary)}.CAMRWW_configTag{background:var(--dsw-alias-bg-layer-1);min-height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:5px;align-items:center;padding:1px 6px;font-size:11px;line-height:16px;display:inline-flex}.CAMRWW_configTag[data-enabled=true]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary)}.CAMRWW_configTag[data-pending=true]{background:color-mix(in srgb, var(--dsw-alias-state-warn-label) 12%, transparent);color:var(--dsw-alias-state-warn-label)}.CAMRWW_chevron{color:var(--dsw-alias-label-tertiary);flex:none}.CAMRWW_card[data-open=true] .CAMRWW_chevron{transform:rotate(180deg)}.CAMRWW_capabilitySwitch{background:var(--dsw-alias-fill-l2);cursor:pointer;border:0;border-radius:999px;flex:0 0 34px;width:34px;height:20px;margin:0 12px 0 2px;padding:0;position:relative}.CAMRWW_capabilitySwitch>span{background:var(--dsw-alias-bg-layer-3);width:14px;height:14px;box-shadow:var(--dsw-shadow-lv1);border-radius:50%;position:absolute;top:3px;left:3px}.CAMRWW_capabilitySwitch[data-checked=true]{background:var(--dsw-alias-state-business-primary)}.CAMRWW_capabilitySwitch[data-checked=true]>span{transform:translate(14px)}.CAMRWW_capabilitySwitch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.CAMRWW_capabilitySwitch:disabled{cursor:not-allowed;opacity:.48}.CAMRWW_cardDetails{border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);padding:10px 14px 12px}.CAMRWW_entryValue{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);font-size:12px;line-height:18px;display:block}.CAMRWW_details{grid-template-columns:76px minmax(0,1fr);gap:6px 10px;margin:8px 0 0;display:grid}.CAMRWW_details div{display:contents}.CAMRWW_details dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.CAMRWW_details dd{overflow-wrap:anywhere;min-width:0;color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:17px}.CAMRWW_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:no-preference){.CAMRWW_chevron,.CAMRWW_capabilitySwitch,.CAMRWW_capabilitySwitch>span{transition:transform .14s var(--ds-ease-in-out), background-color .14s var(--ds-ease-in-out)}}@media (width<=680px){[role=dialog]:has(.CAMRWW_section){flex-direction:column}[role=dialog]:has(.CAMRWW_section)>nav{box-sizing:border-box;flex:none;gap:8px;width:100%;height:auto;padding:16px 48px 8px 12px}[role=dialog]:has(.CAMRWW_section)>nav>div:first-child{width:auto}[role=dialog]:has(.CAMRWW_section)>nav>div:last-child{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px 10px;width:100%;height:auto;display:grid}[role=dialog]:has(.CAMRWW_section)>nav>div:last-child>button{gap:6px;width:100%;padding-left:8px;padding-right:8px}[role=dialog]:has(.CAMRWW_section)>nav>div:last-child>button>span{width:auto;min-width:0}[role=dialog]:has(.CAMRWW_section)>nav+div{width:100%;min-width:0;min-height:0;position:relative}[role=dialog]:has(.CAMRWW_section)>nav+div>div:first-child{z-index:1;width:auto;height:auto;padding:0;position:absolute;top:12px;right:12px}[role=dialog]:has(.CAMRWW_section)>nav+div>div:last-child{box-sizing:border-box;width:100%;padding:0 16px 16px}.CAMRWW_cards{grid-template-columns:minmax(0,1fr)}}";
		...
		var PluginInventorySettingsTab_module_css_default = {
			"capabilitySwitch": "CAMRWW_capabilitySwitch",
			"card": "CAMRWW_card",
			"cardContent": "CAMRWW_cardContent",
			"cardDetails": "CAMRWW_cardDetails",
			"cardHeader": "CAMRWW_cardHeader",
			"cardTitle": "CAMRWW_cardTitle",
			"cardTrailing": "CAMRWW_cardTrailing",
			"cards": "CAMRWW_cards",
			"catalog": "CAMRWW_catalog",
			"catalogHeading": "CAMRWW_catalogHeading",
			"chevron": "CAMRWW_chevron",
			"configTag": "CAMRWW_configTag",
			"details": "CAMRWW_details",
			"entryValue": "CAMRWW_entryValue",
			"failure": "CAMRWW_failure",
			"search": "CAMRWW_search",
			"section": "CAMRWW_section",
			"status": "CAMRWW_status",
			"statusDot": "CAMRWW_statusDot",
			"visuallyHidden": "CAMRWW_visuallyHidden",
			"writeError": "CAMRWW_writeError"
		};
		//#endregion
