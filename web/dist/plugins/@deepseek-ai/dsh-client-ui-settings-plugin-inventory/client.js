window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\24763\AppData\Local\Temp\yunxi-next-dsh-0a50875c14b34d63b17f6522f5dab19c\packages\client\ui-settings-plugin-inventory\src\client\PluginInventorySettingsTab.module.css.mjs
		const css = ".rS5qEW_section{width:100%;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}.rS5qEW_catalogHeading h3,.rS5qEW_status,.rS5qEW_failure p{margin:0}.rS5qEW_status,.rS5qEW_failure{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.rS5qEW_failure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;display:flex}.rS5qEW_failure button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:4px 10px}.rS5qEW_catalog{flex-direction:column;gap:12px;display:flex}.rS5qEW_search{width:100%;color:var(--dsw-alias-label-tertiary);align-items:center;display:flex;position:relative}.rS5qEW_search>svg{pointer-events:none;position:absolute;left:12px}.rS5qEW_search input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:36px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;outline:none;padding:0 34px 0 36px;font-size:13px}.rS5qEW_search input::placeholder{color:var(--dsw-alias-label-tertiary)}.rS5qEW_search input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.rS5qEW_catalogHeading{align-items:baseline;gap:7px;padding:0 2px;display:flex}.rS5qEW_catalogHeading h3{font-size:13px;font-weight:600;line-height:20px}.rS5qEW_catalogHeading span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.rS5qEW_cards{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;margin:0;padding:0;list-style:none;display:grid}.rS5qEW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:8px;min-width:0;overflow:hidden}.rS5qEW_card[data-open=true]{border-color:var(--dsw-alias-border-l1);box-shadow:var(--dsw-shadow-lv1)}.rS5qEW_cardHeader{align-items:center;min-width:0;display:flex}.rS5qEW_cardContent{box-sizing:border-box;min-width:0;min-height:52px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex:auto;justify-content:space-between;align-items:center;gap:10px;padding:12px 8px 12px 14px;display:flex}.rS5qEW_cardContent:hover,.rS5qEW_card[data-open=true] .rS5qEW_cardContent{background:var(--dsw-alias-interactive-bg-hover)}.rS5qEW_cardContent:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.rS5qEW_cardTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;font-weight:600;line-height:20px;overflow:hidden}.rS5qEW_cardTrailing{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:6px;display:inline-flex}.rS5qEW_statusDot{background:var(--dsw-alias-label-tertiary);border-radius:999px;flex:none;width:7px;height:7px;display:inline-block}.rS5qEW_statusDot[data-phase=active]{background:var(--dsw-alias-state-success-primary)}.rS5qEW_statusDot[data-phase=failed]{background:var(--dsw-alias-state-error-primary)}.rS5qEW_statusDot[data-phase=loading]{background:var(--dsw-alias-state-business-primary)}.rS5qEW_configTag{background:var(--dsw-alias-bg-layer-1);min-height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:5px;align-items:center;padding:1px 6px;font-size:11px;line-height:16px;display:inline-flex}.rS5qEW_configTag[data-enabled=true]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary)}.rS5qEW_configTag[data-pending=true]{background:color-mix(in srgb, var(--dsw-alias-state-warn-label) 12%, transparent);color:var(--dsw-alias-state-warn-label)}.rS5qEW_chevron{color:var(--dsw-alias-label-tertiary);flex:none}.rS5qEW_card[data-open=true] .rS5qEW_chevron{transform:rotate(180deg)}.rS5qEW_capabilitySwitch{background:var(--dsw-alias-fill-l2);cursor:pointer;border:0;border-radius:999px;flex:0 0 34px;width:34px;height:20px;margin:0 12px 0 2px;padding:0;position:relative}.rS5qEW_capabilitySwitch>span{background:var(--dsw-alias-bg-layer-3);width:14px;height:14px;box-shadow:var(--dsw-shadow-lv1);border-radius:50%;position:absolute;top:3px;left:3px}.rS5qEW_capabilitySwitch[data-checked=true]{background:var(--dsw-alias-state-business-primary)}.rS5qEW_capabilitySwitch[data-checked=true]>span{transform:translate(14px)}.rS5qEW_capabilitySwitch:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.rS5qEW_capabilitySwitch:disabled{cursor:not-allowed;opacity:.48}.rS5qEW_cardDetails{border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);padding:10px 14px 12px}.rS5qEW_entryValue{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code);font-size:12px;line-height:18px;display:block}.rS5qEW_details{grid-template-columns:76px minmax(0,1fr);gap:6px 10px;margin:8px 0 0;display:grid}.rS5qEW_details div{display:contents}.rS5qEW_details dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.rS5qEW_details dd{overflow-wrap:anywhere;min-width:0;color:var(--dsw-alias-label-secondary);margin:0;font-size:12px;line-height:17px}.rS5qEW_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:no-preference){.rS5qEW_chevron,.rS5qEW_capabilitySwitch,.rS5qEW_capabilitySwitch>span{transition:transform .14s var(--ds-ease-in-out), background-color .14s var(--ds-ease-in-out)}}@media (width<=680px){[role=dialog]:has(.rS5qEW_section){flex-direction:column}[role=dialog]:has(.rS5qEW_section)>nav{box-sizing:border-box;flex:none;gap:8px;width:100%;height:auto;padding:16px 48px 8px 12px}[role=dialog]:has(.rS5qEW_section)>nav>div:first-child{width:auto}[role=dialog]:has(.rS5qEW_section)>nav>div:last-child{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px 10px;width:100%;height:auto;display:grid}[role=dialog]:has(.rS5qEW_section)>nav>div:last-child>button{gap:6px;width:100%;padding-left:8px;padding-right:8px}[role=dialog]:has(.rS5qEW_section)>nav>div:last-child>button>span{width:auto;min-width:0}[role=dialog]:has(.rS5qEW_section)>nav+div{width:100%;min-width:0;min-height:0}[role=dialog]:has(.rS5qEW_section)>nav+div>div:first-child{z-index:1;width:auto;height:auto;padding:0;position:absolute;top:12px;right:12px}[role=dialog]:has(.rS5qEW_section)>nav+div>div:last-child{box-sizing:border-box;width:100%;padding:0 16px 16px}.rS5qEW_cards{grid-template-columns:minmax(0,1fr)}}";
		...
		var PluginInventorySettingsTab_module_css_default = {
			"capabilitySwitch": "rS5qEW_capabilitySwitch",
			"card": "rS5qEW_card",
			"cardContent": "rS5qEW_cardContent",
			"cardDetails": "rS5qEW_cardDetails",
			"cardHeader": "rS5qEW_cardHeader",
			"cardTitle": "rS5qEW_cardTitle",
			"cardTrailing": "rS5qEW_cardTrailing",
			"cards": "rS5qEW_cards",
			"catalog": "rS5qEW_catalog",
			"catalogHeading": "rS5qEW_catalogHeading",
			"chevron": "rS5qEW_chevron",
			"configTag": "rS5qEW_configTag",
			"details": "rS5qEW_details",
			"entryValue": "rS5qEW_entryValue",
			"failure": "rS5qEW_failure",
			"search": "rS5qEW_search",
			"section": "rS5qEW_section",
			"status": "rS5qEW_status",
			"statusDot": "rS5qEW_statusDot",
			"visuallyHidden": "rS5qEW_visuallyHidden"
		};
		//#endregion
